...
!(function (e, t) {
	...
	var s = { title: void 0, field: void 0, columns: void 0, visible: void 0, hozAlign: void 0, vertAlign: void 0, width: void 0, minWidth: 40, maxWidth: void 0, maxInitialWidth: void 0, cssClass: void 0, variableHeight: void 0, headerVertical: void 0, headerHozAlign: void 0, headerWordWrap: !1, editableTitle: void 0 }
	class o {
		constructor(e) {
			return (
				(this._cell = e),
	...
	class n extends t {
		...
		_configureCell() {
			...
			;((e.style.textAlign = this.column.hozAlign), this.column.vertAlign && ((e.style.display = 'inline-flex'), (e.style.alignItems = { top: 'flex-start', bottom: 'flex-end', middle: 'center' }[this.column.vertAlign] || ''), this.column.hozAlign && (e.style.justifyContent = { left: 'flex-start', right: 'flex-end', center: 'center' }[this.column.hozAlign] || '')), t && e.setAttribute('tabulator-field', t), this.column.definition.cssClass) &&
				this.column.definition.cssClass.split(' ').forEach(t => {
					e.classList.add(t)
				})
	...
	class r extends t {
		...
		_buildColumnHeader() {
			...
			;(this.dispatch('column-layout', this), void 0 !== e.visible && (e.visible ? this.show(!0) : this.hide(!0)), e.cssClass) &&
				e.cssClass.split(' ').forEach(e => {
		...
		_buildColumnHeaderTitle() {
			...
			if ((t.classList.add('tabulator-col-title'), e.headerWordWrap && t.classList.add('tabulator-col-title-wrap'), e.editableTitle)) {
				...
				i.classList.add('tabulator-title-editor'),
					...
					t.appendChild(i),
					e.field
						? this.langBind('columns|' + e.field, t => {
								i.value = t || e.title || '&nbsp;'
						  })
						: (i.value = e.title || '&nbsp;')
			} else
				e.field
					? this.langBind('columns|' + e.field, i => {
		...
		_buildGroupHeader() {
			;(this.element.classList.add('tabulator-col-group'), this.element.setAttribute('role', 'columngroup'), this.element.setAttribute('aria-title', this.definition.title), this.definition.cssClass) &&
				this.definition.cssClass.split(' ').forEach(e => {
					this.element.classList.add(e)
				})
		...
		setMinWidth(e) {
			this.maxWidth && e > this.maxWidth && ((e = this.maxWidth), console.warn('the minWidth (' + e + "px) for column '" + this.field + "' cannot be bigger that its maxWidth (" + this.maxWidthStyled + ')')),
				(this.minWidth = e),
		...
		setMaxWidth(e) {
			this.minWidth && e < this.minWidth && ((e = this.minWidth), console.warn('the maxWidth (' + e + "px) for column '" + this.field + "' cannot be smaller that its minWidth (" + this.minWidthStyled + ')')),
				(this.maxWidth = e),
		...
		updateDefinition(e) {
			...
			return this.isGroup || this.parent.isGroup
				? (console.error('Column Update Error - The updateDefinition function is only available on ungrouped columns'), Promise.reject('Column Update Error - The updateDefinition function is only available on columns, not column groups'))
				: ((t = Object.assign({}, this.getDefinition())), (t = Object.assign(t, e)), this.table.columnManager.addColumn(t, !1, this).then(e => (t.field == this.field && (this.field = !1), this.delete().then(() => e.getComponent()))))
		}
		deleteCell(e) {
	...
	class a {
		...
		static elOffset(e) {
			...
			return { top: t.top + window.pageYOffset - document.documentElement.clientTop, left: t.left + window.pageXOffset - document.documentElement.clientLeft }
		}
		...
		static deepClone(e, t, i = []) {
			...
			for (var n in (t || (t = Object.assign(Array.isArray(e) ? [] : {}, e)), e)) {
				let r,
					a,
					l = e[n]
				null == l || 'object' != typeof l || (l.__proto__ !== s && l.__proto__ !== o) || ((r = i.findIndex(e => e.subject === l)), r > -1 ? (t[n] = i[r].copy) : ((a = Object.assign(Array.isArray(l) ? [] : {}, l)), i.unshift({ subject: l, copy: a }), (t[n] = this.deepClone(l, a, i))))
			}
			return t
		}
	}
	...
	class c extends h {
		...
		rerenderColumns(e, t) {
			...
			;(e && !this.initialized) ||
				...
				this.table.columnManager.columnsByIndex.forEach(e => {
					...
					e.visible &&
						(e.modules.frozen ||
							((t = e.getWidth()), (i.leftPos = s), (i.rightPos = s + t), (i.width = t), this.isFitData && (i.fitDataCheck = !e.modules.vdomHoz || e.modules.vdomHoz.fitDataCheck), s + t > this.vDomScrollPosLeft && s < this.vDomScrollPosRight ? (-1 == this.leftCol && ((this.leftCol = this.columns.length), (this.vDomPadLeft = s)), (this.rightCol = this.columns.length)) : -1 !== this.leftCol && (this.vDomPadRight += t), this.columns.push(e), (e.modules.vdomHoz = i), (s += t)))
				}),
		...
		renderRowCells(e) {
			if (this.initialized) this.initializeRow(e)
			else {
		...
		addColRight() {
			for (var e = !1, t = !0; t; ) {
				...
				i && i.modules.vdomHoz.leftPos <= this.vDomScrollPosRight
					? ((e = !0),
		...
		removeColLeft() {
			for (var e = !1, t = !0; t; ) {
				...
				i && i.modules.vdomHoz.rightPos < this.vDomScrollPosLeft
					? ((e = !0),
					  this.getVisibleRows().forEach(e => {
							if ('group' !== e.type) {
								var t = e.getCell(i)
	...
	class u extends t {
				...
				if (
					(s.forEach(e => {
						Object.keys(e).forEach((s, o) => {
							let n,
								r = e[s]
							i[s] ? !0 !== i[s] && void 0 !== r && ((i[s].sorter = this.calculateSorterFromValue(r)), (i[s] = !0)) : ((n = { field: s, title: s, sorter: this.calculateSorterFromValue(r) }), t.splice(o, 0, n), (i[s] = void 0 !== r || n))
						})
					}),
					o)
				)
		...
		setColumns(e, t) {
			...
			;(this.columns = []),
				...
				this.table.options.rowHeader && ((this.rowHeader = new r(!0 === this.table.options.rowHeader ? {} : this.table.options.rowHeader, this, !0)), this.columns.push(this.rowHeader), this.headersElement.appendChild(this.rowHeader.getElement()), this.rowHeader.columnRendered()),
				e.forEach((e, t) => {
					this._addColumn(e)
				}),
		...
		getComponents(e) {
			var t = []
			return (
				(e ? this.columns : this.columnsByIndex).forEach(e => {
		...
		_moveColumnInArray(e, t, i, s, o) {
			...
			r > -1 &&
				...
				e.splice(n, 0, t),
				o &&
					(this.chain('column-moving-rows', [t, i, s], null, []) || []).concat(this.table.rowManager.rows).forEach(function (e) {
						if (e.cells.length) {
		...
		getFlexBaseWidth() {
			var e = this.table.element.clientWidth,
				t = 0
			return (
				this.table.rowManager.element.scrollHeight > this.table.rowManager.element.clientHeight && (e -= this.table.rowManager.element.offsetWidth - this.table.rowManager.element.clientWidth),
	...
	class b extends h {
		...
		rerenderRows(e) {
			...
			n.forEach(e => {
				...
				e && e(),
				this.rows().length ? this._virtualRenderFill(!1 === i ? this.rows.length - 1 : i, !0, s || 0) : (this.clear(), this.table.rowManager.tableEmpty()),
			...
			if (g && a.elVisible(this.elementVertical)) {
				for (this.vDomTop = e, this.vDomBottom = e - 1, C || this.table.options.maxHeight ? (y && (w = E / y + this.vDomWindowBuffer / y), (w = Math.max(this.vDomWindowMinTotalRows, Math.ceil(w)))) : (w = g); (w == g || h <= E + this.vDomWindowBuffer || v < this.vDomWindowMinTotalRows) && this.vDomBottom < g - 1; ) {
					...
					n.appendChild(o),
						...
						(E = this.elementVertical.clientHeight),
						R && (C || this.table.options.maxHeight) && ((y = h / v), (w = Math.max(this.vDomWindowMinTotalRows, Math.ceil(E / y + this.vDomWindowBuffer / y))))
				}
				e ? ((this.vDomTopPad = t ? this.vDomRowHeight * this.vDomTop + i : this.scrollTop - u), (this.vDomBottomPad = this.vDomBottom == g - 1 ? 0 : Math.max(this.vDomScrollHeight - this.vDomTopPad - h - u, 0))) : ((this.vDomTopPad = 0), (this.vDomRowHeight = Math.floor((h + u) / v)), (this.vDomBottomPad = this.vDomRowHeight * (g - this.vDomBottom - 1)), (this.vDomScrollHeight = u + h + this.vDomBottomPad - E)),
	...
	class f extends t {
		...
		setData(e, t, i) {
			return new Promise((s, o) => {
				t && this.getDisplayRows().length
					? this.table.options.pagination
						? this._setDataActual(e, !0)
						: this.reRenderInPosition(() => {
								this._setDataActual(e)
						  })
					: (this.table.options.autoColumns && i && this.table.initialized && this.table.columnManager.generateColumnsFromRowData(e), this.resetScroll(), this._setDataActual(e)),
					s()
			})
		}
		_setDataActual(e, t) {
			this.dispatchExternal('dataProcessing', e),
				this._wipeElements(),
				Array.isArray(e)
					? (this.dispatch('data-processing', e),
					  e.forEach((e, t) => {
					  ...
					  this.dispatchExternal('dataProcessed', e))
		...
		registerDataPipelineHandler(e, t) {
			void 0 !== t ? (this.dataPipeline.push({ handler: e, priority: t }), this.dataPipeline.sort((e, t) => e.priority - t.priority)) : console.error('Data pipeline handlers must have a priority in order to be registered')
		}
		registerDisplayPipelineHandler(e, t) {
			void 0 !== t ? (this.displayPipeline.push({ handler: e, priority: t }), this.displayPipeline.sort((e, t) => e.priority - t.priority)) : console.error('Display pipeline handlers must have a priority in order to be registered')
		}
		refreshActiveData(e, t, i) {
			...
			if (!this.table.destroyed) {
				...
				if (this.redrawBlock) return void ((!this.redrawBlockRestoreConfig || (this.redrawBlockRestoreConfig && ((this.redrawBlockRestoreConfig.stage === o && n < this.redrawBlockRestoreConfig.index) || r.indexOf(o) < r.indexOf(this.redrawBlockRestoreConfig.stage)))) && (this.redrawBlockRestoreConfig = { handler: e, skipStage: t, renderInPosition: i, stage: o, index: n }))
		...
		initializeRenderer() {
			var e,
				t = { virtual: b, basic: g }
			;(e = 'string' == typeof this.table.options.renderVertical ? t[this.table.options.renderVertical] : this.table.options.renderVertical)
				? ((this.renderMode = this.table.options.renderVertical), (this.renderer = new e(this.table, this.element, this.tableElement)), this.renderer.initialize(), (!this.table.element.clientHeight && !this.table.options.height) || (this.table.options.minHeight && this.table.options.maxHeight) ? (this.fixedHeight = !1) : (this.fixedHeight = !0))
	...
	class w extends t {
		...
		bindComponents(e, t) {
			...
			for (let e of i) {
				...
				i && ((o[e] = i), (n[e] = { target: r, component: i }))
			}
	...
	class R {
		...
		subscribe(e, t, i = 1e4) {
			this.events[e] || (this.events[e] = []), this.events[e].push({ callback: t, priority: i }), this.events[e].sort((e, t) => e.priority - t.priority), this._notifySubscriptionChange(e, !0)
		}
		unsubscribe(e, t) {
			var i
			if (this.events[e]) {
		...
		show(e, t) {
			...
			return (
				this.destroyed ||
					...
					(e instanceof HTMLElement ? ((o = e), (n = (r = this.elementPositionCoords(e, t)).offset), (i = r.x), (s = r.y)) : 'number' == typeof e ? ((n = { top: 0, left: 0 }), (i = e), (s = t)) : ((i = (r = this.containerEventCoords(e)).x), (s = r.y), (this.reversedX = !1)),
			...
			return (
				this.visible &&
					...
					(this.blurable &&
						...
						(document.body.removeEventListener('keydown', this.escEvent), document.body.removeEventListener('click', this.blurEvent), document.body.removeEventListener('contextmenu', this.blurEvent), document.body.removeEventListener('mousedown', this.blurEvent), window.removeEventListener('resize', this.blurEvent), this.table.rowManager.element.removeEventListener('scroll', this.blurEvent), this.unsubscribe('cell-editing', this.blurEvent), (this.blurEventsBound = !1)),
	...
	var L = {
		...
		fitColumns: function (e, t) {
			...
			this.table.options.responsiveLayout && this.table.modExists('responsiveLayout', !0) && this.table.modules.responsiveLayout.update(),
				...
				e.forEach(function (e) {
					var t, i, s
					e.visible && ((t = e.definition.width), (i = parseInt(e.minWidth)), t ? ((s = u(t)), (n += s > i ? s : i), e.definition.widthShrink && (h.push({ column: e, width: s > i ? s : i }), (d += e.definition.widthShrink))) : (l.push({ column: e, width: 0 }), (a += e.definition.widthGrow || 1)))
				}),
				(r = o - n),
				(i = Math.floor(r / a)),
				(c = m(l, r, i, !1)),
	...
	var D = { default: { groups: { item: 'item', items: 'items' }, columns: {}, data: { loading: 'Loading', error: 'Error' }, pagination: { page_size: 'Page Size', page_title: 'Show Page', first: 'First', first_title: 'First Page', last: 'Last', last_title: 'Last Page', prev: 'Prev', prev_title: 'Prev Page', next: 'Next', next_title: 'Next Page', all: 'All', counter: { showing: 'Showing', of: 'of', rows: 'rows', pages: 'pages' } }, headerFilters: { default: 'filter column...', columns: {} } } }
	class z extends M {
		...
		initialize() {
			;(this.langList = a.deepClone(z.langs)), !1 !== this.table.options.columnDefaults.headerFilterPlaceholder && this.setHeaderFilterPlaceholder(this.table.options.columnDefaults.headerFilterPlaceholder)
	...
	var P = Object.freeze({
		...
		CommsModule: class extends M {
			...
			getConnections(e) {
				var t = []
				return (
					this.table.constructor.registry.lookupTable(e).forEach(e => {
	...
	class F {
		static registry = {
			tables: [],
			register(e) {
				F.registry.tables.push(e)
			},
			deregister(e) {
				var t = F.registry.tables.indexOf(e)
				t > -1 && F.registry.tables.splice(t, 1)
			},
			lookupTable(e, t) {
				var i,
					s,
					o = []
				if ('string' == typeof e) {
					if ((i = document.querySelectorAll(e)).length) for (var n = 0; n < i.length; n++) (s = F.registry.matchElement(i[n])) && o.push(s)
				} else
					('undefined' != typeof HTMLElement && e instanceof HTMLElement) || e instanceof F
						? (s = F.registry.matchElement(e)) && o.push(s)
						: Array.isArray(e)
						? e.forEach(function (e) {
								o = o.concat(F.registry.lookupTable(e))
						  })
						: t || console.warn('Table Connection Error - Invalid Selector', e)
				return o
			},
			matchElement: e =>
				F.registry.tables.find(function (t) {
					return e instanceof F ? t === e : t.element === e
				}),
		}
		static findTable(e) {
			var t = F.registry.lookupTable(e, !0)
	...
	class H extends F {
		...
		static initializeModuleBinder(e) {
			H.modulesRegistered || ((H.modulesRegistered = !0), H._registerModules(P, !0), e && H._registerModules(e))
		}
		static _extendModule(e, t, i) {
			if (H.moduleBindings[e]) {
				var s = H.moduleBindings[e][t]
				if (s)
					if ('object' == typeof i) for (let e in i) s[e] = i[e]
		...
		static _registerModule(e) {
			Array.isArray(e) || (e = [e]),
				e.forEach(e => {
					H._registerModuleBinding(e), H._registerModuleExtensions(e)
				})
		}
		static _registerModuleBinding(e) {
			e.moduleName ? (H.moduleBindings[e.moduleName] = e) : console.error('Unable to bind module, no moduleName defined', e.moduleName)
		}
		static _registerModuleExtensions(e) {
			...
			if (e.moduleExtensions)
				for (let e in t) {
					let i = t[e]
					if (H.moduleBindings[e]) for (let t in i) H._extendModule(e, t, i[t])
					else {
						H.moduleExtensions[e] || (H.moduleExtensions[e] = {})
						for (let t in i) H.moduleExtensions[e][t] || (H.moduleExtensions[e][t] = {}), Object.assign(H.moduleExtensions[e][t], i[t])
					}
				}
			H._extendModuleFromQueue(e)
		}
		static _extendModuleFromQueue(e) {
			var t = H.moduleExtensions[e.moduleName]
			if (t) for (let i in t) H._extendModule(e.moduleName, i, t[i])
		}
		_bindModules() {
			var e = [],
				t = [],
				i = []
			for (var s in ((this.modules = {}), H.moduleBindings)) {
				let o = H.moduleBindings[s],
					n = new o(this)
	...
	class O extends H {
		...
		_detectBrowser() {
			...
			e.indexOf('Trident') > -1 ? ((this.browser = 'ie'), (this.browserSlow = !0)) : e.indexOf('Edge') > -1 ? ((this.browser = 'edge'), (this.browserSlow = !0)) : e.indexOf('Firefox') > -1 ? ((this.browser = 'firefox'), (this.browserSlow = !1)) : e.indexOf('Mac OS') > -1 ? ((this.browser = 'safari'), (this.browserSlow = !1)) : ((this.browser = 'other'), (this.browserSlow = !1)),
				(this.browserMobile =
			...
			return (
				...
				new Promise((s, o) => {
					this.dataLoader.blockActiveLoad(),
						'string' == typeof e && (e = JSON.parse(e)),
						e
							? this.rowManager.addRows(e, t, i).then(e => {
									var t = []
									e.forEach(function (e) {
										t.push(e.getComponent())
									}),
		...
		deleteRow(e) {
			...
			return (
				t.sort((e, t) => (this.rowManager.rows.indexOf(e) > this.rowManager.rows.indexOf(t) ? 1 : -1)),
				t.forEach(e => {
					e.delete()
				}),
	...
	class B extends M {
		...
		initializeColumn(e) {
			...
			this.allowedTypes.forEach(s => {
				...
				e.definition[n] && (o = this.lookupAccessor(e.definition[n])) && ((t = !0), (i[n] = { accessor: o, params: e.definition[n + 'Params'] || {} }))
			}),
	...
	function W(e, t, i) {
		return e && i && Object.keys(i).length && ((t.method && 'get' != t.method.toLowerCase()) || ((t.method = 'get'), (e += (e.includes('?') ? '&' : '?') + N(i)))), e
	}
	function j(e, t, i) {
		var s
		return new Promise((o, n) => {
			...
			e
				? (void 0 === t.headers && (t.headers = {}),
				  ...
				  'cors' == t.mode ? (void 0 === t.headers.Origin && (t.headers.Origin = window.location.origin), void 0 === t.credentials && (t.credentials = 'same-origin')) : void 0 === t.credentials && (t.credentials = 'include'),
				  fetch(e, t)
						.then(e => {
							e.ok
								? e
	...
	function G(e, t) {
		...
		else if ('object' == typeof e) for (var s in e) i = i.concat(G(e[s], t ? t + '[' + s + ']' : s))
		else i.push({ key: t, value: e })
		return i
	}
	var U = {
	...
	class Y extends M {
					...
					this.table.element.addEventListener('copy', e => {
						...
						this.blocked ||
							...
							this.customSelection
								? ((t = this.customSelection), this.table.options.clipboardCopyFormatter && (t = this.table.options.clipboardCopyFormatter('plain', t)))
								: ((s = this.table.modules.export.generateExportList(this.table.options.clipboardCopyConfig, this.table.options.clipboardCopyStyled, this.rowRange, 'clipboard')), (t = (i = this.table.modules.export.generateHTMLTable(s)) ? this.generatePlainContent(s) : ''), this.table.options.clipboardCopyFormatter && ((t = this.table.options.clipboardCopyFormatter('plain', t)), (i = this.table.options.clipboardCopyFormatter('html', i)))),
		...
		setPasteAction(e) {
			switch (typeof e) {
				case 'string':
					;(this.pasteAction = Y.pasteActions[e]), this.pasteAction || console.warn('Clipboard Error - No such paste action found:', e)
					break
				case 'function':
					this.pasteAction = e
			}
		...
		setPasteParser(e) {
			switch (typeof e) {
				case 'string':
					;(this.pasteParser = Y.pasteParsers[e]), this.pasteParser || console.warn('Clipboard Error - No such paste parser found:', e)
					break
				case 'function':
					this.pasteParser = e
			}
	...
	class Z extends M {
		...
		initialize() {
			;(this.genColumn = new r({ field: 'value' }, this)),
		...
		initializeColumn(e) {
			var t = e.definition,
				i = { topCalcParams: t.topCalcParams || {}, botCalcParams: t.bottomCalcParams || {} }
			if (t.topCalc) {
		...
		recalcAll() {
			;(this.topCalcs.length || this.botCalcs.length) &&
				...
				this.table.options.groupBy &&
					...
					this.table.modules.groupRows.getChildGroups().forEach(e => {
						this.recalcGroup(e)
					}))
		}
		recalcGroup(e) {
				...
				e.forEach(e => {
					t.push(e.getData()),
						i &&
							...
							this.rowsToData(s.getFilteredTreeChildren(e)).forEach(i => {
								t.push(e)
							})
				}),
				t
		...
		getResults() {
			...
			return (
				this.table.options.groupBy && this.table.modExists('groupRows')
					? this.table.modules.groupRows.getGroups(!0).forEach(t => {
							e[t.getKey()] = this.getGroupResults(t)
					  })
					: (e = { top: this.topRow ? this.topRow.getData() : {}, bottom: this.botRow ? this.botRow.getData() : {} }),
				e
			)
		}
		getGroupResults(e) {
			...
			return (
				...
				{ top: t.calcs.top ? t.calcs.top.getData() : {}, bottom: t.calcs.bottom ? t.calcs.bottom.getData() : {}, groups: s }
			)
		}
	...
	var ee = {
		...
		pdf: function (e, t = {}, i) {
			var s = [],
				...
				a = t.rowCalcStyles || { fontStyle: 'bold', fontSize: 10, cellPadding: 4, fillColor: 232 },
				l = t.jsPDF || {},
				h = t.title ? t.title : ''
			function d(e, t) {
				var i = []
				return (
					e.columns.forEach(e => {
						...
						if (e) {
							...
							;(s = { content: e.value, colSpan: e.width, rowSpan: e.height }), t && (s.styles = t), i.push(s)
						}
					}),
					i
				)
		...
		xlsx: function (e, i, s) {
			var o = i.sheetName || 'Sheet1',
				...
				l = i.writeOptions || { bookType: 'xlsx', bookSST: !0, compression: a }
			function h() {
				var t = [],
					i = [],
					s = {},
					o = { s: { c: 0, r: 0 }, e: { c: e[0] ? e[0].columns.reduce((e, t) => e + (t && t.width ? t.width : 1), 0) : 0, r: e.length } }
				return (
					e.forEach((e, s) => {
						var o = []
						e.columns.forEach(function (e, t) {
							e ? (o.push(e.value instanceof Date || 'object' != typeof e.value ? e.value : JSON.stringify(e.value)), (e.width > 1 || e.height > -1) && (e.height > 1 || e.width > 1) && i.push({ s: { r: s, c: t }, e: { r: s + e.height - 1, c: t + e.width - 1 } })) : o.push('')
						}),
							t.push(o)
					}),
			...
			if (((l.type = 'binary'), (n.SheetNames = []), (n.Sheets = {}), i.sheetOnly)) s(h())
			else {
				if (i.sheets)
					for (var d in i.sheets)
						!0 === i.sheets[d]
							? (n.SheetNames.push(d), (n.Sheets[d] = h()))
							: (n.SheetNames.push(d),
	...
	class te extends M {
		...
		download(e, t, i, s, o) {
			var n = !1
			if (('function' == typeof e ? (n = e) : te.downloaders[e] ? (n = te.downloaders[e]) : console.warn('Download Error - No such download type found: ', e), n)) {
	...
	let se = class {
		constructor(e, t, i, s, o, n) {
			;(this.edit = e),
				...
				(this.filterTerm = ''),
				(this.blurable = !0),
				(this.actions = { success: s, cancel: o }),
		...
		_createInputElement() {
			...
			return this.params.mask && ie(t, this.params), this._bindInputEvents(t), t
		}
		_initializeParams(e) {
			var t,
				i = ['values', 'valuesURL', 'valuesLookup']
			return (
				((e = Object.assign({}, e)).verticalNavigation = e.verticalNavigation || 'editor'),
				...
				e.autocomplete
					? e.multiselect && ((e.multiselect = !1), console.warn('list editor config error - multiselect option is not available when autocomplete is enabled'))
					: (e.freetext && ((e.freetext = !1), console.warn('list editor config error - freetext option is only available when autocomplete is enabled')),
					  e.filterFunc && ((e.filterFunc = !1), console.warn('list editor config error - filterFunc option is only available when autocomplete is enabled')),
					  e.filterRemote && ((e.filterRemote = !1), console.warn('list editor config error - filterRemote option is only available when autocomplete is enabled')),
					  e.mask && ((e.mask = !1), console.warn('list editor config error - mask option is only available when autocomplete is enabled')),
					  e.allowEmpty && ((e.allowEmpty = !1), console.warn('list editor config error - allowEmpty option is only available when autocomplete is enabled')),
					  e.listOnEmpty && ((e.listOnEmpty = !1), console.warn('list editor config error - listOnEmpty option is only available when autocomplete is enabled'))),
				e.filterRemote && 'function' != typeof e.valuesLookup && !e.valuesURL && ((e.filterRemote = !1), console.warn('list editor config error - filterRemote option should only be used when values list is populated from a remote source')),
				e
			)
		}
		_bindInputEvents(e) {
		...
		_generateOptions(e) {
			...
			return (
				...
				t instanceof Promise ? (e || this._addPlaceholder(this.params.placeholderLoading), t.then().then(e => (this.listIteration === i ? this._parseList(e) : Promise.reject(i)))) : Promise.resolve(this._parseList(t))
			)
		}
		_addPlaceholder(e) {
		...
		_ajaxRequest(e, t) {
			return (
				(e = W(e, {}, this.params.filterRemote ? { term: t } : {})),
				fetch(e)
					.then(e => (e.ok ? e.json().catch(e => (console.warn('List Ajax Load Error - Invalid JSON returned', e), Promise.reject(e))) : (console.error('List Ajax Load Error - Connection Error: ' + e.status, e.statusText), Promise.reject(e))))
					.catch(e => (console.error('List Ajax Load Error - Connection Error: ', e), Promise.reject(e)))
			)
		}
		_uniqueColumnValues(e) {
			...
			return (
				(t = e ? this.table.columnManager.getColumnByField(e) : this.cell.getColumn()._getSelf())
					? s.forEach(e => {
							var s = t.getFieldValue(e)
							null != s && '' !== s && (i[s] = !0)
					  })
					: (console.warn('unable to find matching column to create select lookup list:', e), (i = [])),
				Object.keys(i)
			)
		}
		_parseList(e) {
			var t = []
			return (
				Array.isArray(e) || (e = Object.entries(e).map(([e, t]) => ({ label: t, value: e }))),
				e.forEach(e => {
					'object' != typeof e && (e = { label: e, value: e }), this._parseListItem(e, t, 0)
				}),
		...
		_parseListItem(e, t, i) {
			var s = {}
			e.options ? (s = this._parseListGroup(e, i + 1)) : ((s = { label: e.label, value: e.value, itemParams: e.itemParams, elementAttributes: e.elementAttributes, element: !1, selected: !1, visible: !0, level: i, original: e }), this.initialValues && this.initialValues.indexOf(e.value) > -1 && this._chooseItem(s, !0)), t.push(s)
		}
		_parseListGroup(e, t) {
			var i = { label: e.label, group: !0, itemParams: e.itemParams, elementAttributes: e.elementAttributes, element: !1, visible: !0, level: t, options: [], original: e }
			return (
				e.options.forEach(e => {
			...
			return (
				i.group
					? (i.options.forEach(i => {
					  ...
					  (i.visible = s))
					: (i.visible = e(t, i.label, i.value, i.original)),
				i.visible
			)
		}
		...
		_buildItem(e) {
			...
			if (!this.filtered || e.visible) {
				if (!i) {
					if ((((i = document.createElement('div')).tabIndex = 0), (t = this.params.itemFormatter ? this.params.itemFormatter(e.label, e.value, e.original, i) : e.label) instanceof HTMLElement ? i.appendChild(t) : (i.innerHTML = t), e.group ? i.classList.add('tabulator-edit-list-group') : i.classList.add('tabulator-edit-list-item'), i.classList.add('tabulator-edit-list-group-level-' + e.level), e.elementAttributes && 'object' == typeof e.elementAttributes))
						for (let t in e.elementAttributes) '+' == t.charAt(0) ? ((t = t.slice(1)), i.setAttribute(t, this.input.getAttribute(t) + e.elementAttributes['+' + t])) : i.setAttribute(t, e.elementAttributes[t])
	...
	var oe = {
		input: function (e, t, i, s, o) {
			...
			return (
				(r.value = void 0 !== n ? n : ''),
				t(function () {
					'cell' === e.getType() && (r.focus({ preventScroll: !0 }), (r.style.height = '100%'), o.selectContents && r.select())
				}),
		...
		textarea: function (e, t, i, s, o) {
			...
			return (
				(l.value = a),
				t(function () {
					'cell' === e.getType() && (l.focus({ preventScroll: !0 }), (l.style.height = '100%'), l.scrollHeight, (l.style.height = l.scrollHeight + 'px'), e.getRow().normalizeHeight(), o.selectContents && l.select())
				}),
		...
		number: function (e, t, i, s, o) {
			...
			if ((a.setAttribute('type', 'number'), void 0 !== o.max && a.setAttribute('max', o.max), void 0 !== o.min && a.setAttribute('min', o.min), void 0 !== o.step && a.setAttribute('step', o.step), (a.style.padding = '4px'), (a.style.width = '100%'), (a.style.boxSizing = 'border-box'), o.elementAttributes && 'object' == typeof o.elementAttributes))
				for (let e in o.elementAttributes) '+' == e.charAt(0) ? ((e = e.slice(1)), a.setAttribute(e, a.getAttribute(e) + o.elementAttributes['+' + e])) : a.setAttribute(e, o.elementAttributes[e])
			a.value = n
			var l = function (e) {
				h()
			}
			...
			return (
				t(function () {
					'cell' === e.getType() && (a.removeEventListener('blur', l), a.focus({ preventScroll: !0 }), (a.style.height = '100%'), a.addEventListener('blur', l), o.selectContents && a.select())
				}),
		...
		range: function (e, t, i, s, o) {
			var n = e.getValue(),
				r = document.createElement('input')
			if ((r.setAttribute('type', 'range'), void 0 !== o.max && r.setAttribute('max', o.max), void 0 !== o.min && r.setAttribute('min', o.min), void 0 !== o.step && r.setAttribute('step', o.step), (r.style.padding = '4px'), (r.style.width = '100%'), (r.style.boxSizing = 'border-box'), o.elementAttributes && 'object' == typeof o.elementAttributes))
				for (let e in o.elementAttributes) '+' == e.charAt(0) ? ((e = e.slice(1)), r.setAttribute(e, r.getAttribute(e) + o.elementAttributes['+' + e])) : r.setAttribute(e, o.elementAttributes[e])
			function a() {
				var e = r.value
				isNaN(e) || '' === e || (e = Number(e)), e != n ? i(e) && (n = e) : s()
			}
			return (
				(r.value = n),
				t(function () {
					'cell' === e.getType() && (r.focus({ preventScroll: !0 }), (r.style.height = '100%'))
				}),
		...
		date: function (e, t, i, s, o) {
			...
			function c() {
				...
				if ((null == l && '' !== t) || t !== l) {
					if (t && n)
						switch (((e = a.fromFormat(String(t), 'yyyy-MM-dd')), n)) {
							case !0:
								t = e
								break
							case 'iso':
			...
			return (
				...
				(h.value = l),
				t(function () {
					'cell' === e.getType() && (h.focus({ preventScroll: !0 }), (h.style.height = '100%'), o.selectContents && h.select())
				}),
		...
		time: function (e, t, i, s, o) {
			...
			function c() {
				...
				if ((null == h && '' !== t) || t !== h) {
					if (t && r)
						switch (((e = l.fromFormat(String(t), 'hh:mm')), r)) {
							case !0:
								t = e
								break
							case 'iso':
			...
			return (
				(h = void 0 !== h ? h : ''),
				r && (l ? ((n = l.isDateTime(h) ? h : 'iso' === r ? l.fromISO(String(h)) : l.fromFormat(String(h), r)), (h = n.toFormat('HH:mm'))) : console.error("Editor Error - 'date' editor 'format' param is dependant on luxon.js")),
				(d.value = h),
				t(function () {
					'cell' == e.getType() && (d.focus({ preventScroll: !0 }), (d.style.height = '100%'), o.selectContents && d.select())
				}),
		...
		datetime: function (e, t, i, s, o) {
			...
			return (
				(h = void 0 !== h ? h : ''),
				r && (l ? ((n = l.isDateTime(h) ? h : 'iso' === r ? l.fromISO(String(h)) : l.fromFormat(String(h), r)), (h = n.toFormat('yyyy-MM-dd') + 'T' + n.toFormat('HH:mm'))) : console.error("Editor Error - 'date' editor 'format' param is dependant on luxon.js")),
				(d.value = h),
				t(function () {
					'cell' === e.getType() && (d.focus({ preventScroll: !0 }), (d.style.height = '100%'), o.selectContents && d.select())
				}),
		...
		star: function (e, t, i, s, o) {
			...
			function m(e) {
				d.forEach(function (t, i) {
					i < e
						? ('ie' == n.table.browser ? t.setAttribute('class', 'tabulator-star-active') : t.classList.replace('tabulator-star-inactive', 'tabulator-star-active'), (t.innerHTML = '<polygon fill="#488CE9" stroke="#014AAE" stroke-width="37.6152" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" points="259.216,29.942 330.27,173.919 489.16,197.007 374.185,309.08 401.33,467.31 259.216,392.612 117.104,467.31 144.25,309.08 29.274,197.007 188.165,173.919 "/>'))
						: ('ie' == n.table.browser ? t.setAttribute('class', 'tabulator-star-inactive') : t.classList.replace('tabulator-star-active', 'tabulator-star-inactive'), (t.innerHTML = '<polygon fill="#010155" stroke="#686868" stroke-width="37.6152" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" points="259.216,29.942 330.27,173.919 489.16,197.007 374.185,309.08 401.33,467.31 259.216,392.612 117.104,467.31 144.25,309.08 29.274,197.007 188.165,173.919 "/>'))
				})
			}
			function p(e) {
			...
			if (((r.style.whiteSpace = 'nowrap'), (r.style.overflow = 'hidden'), (r.style.textOverflow = 'ellipsis'), (c.style.verticalAlign = 'middle'), (c.style.display = 'inline-block'), (c.style.padding = '4px'), u.setAttribute('width', h), u.setAttribute('height', h), u.setAttribute('viewBox', '0 0 512 512'), u.setAttribute('xml:space', 'preserve'), (u.style.padding = '0 1px'), o.elementAttributes && 'object' == typeof o.elementAttributes))
				for (let e in o.elementAttributes) '+' == e.charAt(0) ? ((e = e.slice(1)), c.setAttribute(e, c.getAttribute(e) + o.elementAttributes['+' + e])) : c.setAttribute(e, o.elementAttributes[e])
			for (var b = 1; b <= l; b++) p(b)
			return (
				m((a = Math.min(parseInt(a), l))),
		...
		progress: function (e, t, i, s, o) {
			...
			if (((u.style.position = 'absolute'), (u.style.right = '0'), (u.style.top = '0'), (u.style.bottom = '0'), (u.style.width = '5px'), u.classList.add('tabulator-progress-handle'), (m.style.display = 'inline-block'), (m.style.position = 'relative'), (m.style.height = '100%'), (m.style.backgroundColor = '#488CE9'), (m.style.maxWidth = '100%'), (m.style.minWidth = '0%'), o.elementAttributes && 'object' == typeof o.elementAttributes))
				for (let e in o.elementAttributes) '+' == e.charAt(0) ? ((e = e.slice(1)), m.setAttribute(e, m.getAttribute(e) + o.elementAttributes['+' + e])) : m.setAttribute(e, o.elementAttributes[e])
			return (
				(a.style.padding = '4px 4px'),
		...
		tickCross: function (e, t, i, s, o) {
			...
			return (
				(r.value = n),
				!a || (void 0 !== n && n !== l && '' !== n) || ((h = !0), (r.indeterminate = !0)),
				'firefox' != this.table.browser &&
					'safari' != this.table.browser &&
					t(function () {
						'cell' === e.getType() && r.focus({ preventScroll: !0 })
					}),
	...
	class ne extends M {
		...
		keybindingNavigateNext(e) {
			...
			t &&
				(this.navigateNext(t, e) ||
					(i &&
						(t.getElement().firstChild.blur(),
						this.invalidEdit ||
							(i = !0 === i ? this.table.addRow({}) : 'function' == typeof i ? this.table.addRow(i(t.row.getComponent())) : this.table.addRow(Object.assign({}, i))).then(() => {
								setTimeout(() => {
		...
		initializeColumn(e) {
			var t = Object.keys(e.definition).includes('editorEmptyValue'),
				i = { editor: !1, blocked: !1, check: e.definition.editable, params: e.definition.editorParams || {}, convertEmptyValues: t, editorEmptyValue: e.definition.editorEmptyValue, editorEmptyValueFunc: e.definition.editorEmptyValueFunc }
		...
		bindEditor(e) {
			if (e.column.modules.edit) {
				...
				this.updateCellClass(e),
					...
					'dblclick' === this.options('editTriggerEvent') &&
						i.addEventListener('dblclick', function (s) {
							i.classList.contains('tabulator-editing') || (i.focus({ preventScroll: !0 }), t.edit(e, s, !1))
						}),
					('focus' !== this.options('editTriggerEvent') && 'click' !== this.options('editTriggerEvent')) ||
						i.addEventListener('click', function (s) {
							i.classList.contains('tabulator-editing') || (i.focus({ preventScroll: !0 }), t.edit(e, s, !1))
						}),
					'focus' === this.options('editTriggerEvent') &&
		...
		focusScrollAdjust(e) {
			if ('virtual' == this.table.rowManager.getRenderMode()) {
				...
				var o = this.table.rowManager.element.scrollLeft,
					...
					r = e.getElement()
				this.table.modExists('frozenColumns') && ((o += parseInt(this.table.modules.frozenColumns.leftMargin || 0)), (n -= parseInt(this.table.modules.frozenColumns.rightMargin || 0))),
					'virtual' === this.table.options.renderHorizontal && ((o -= parseInt(this.table.columnManager.renderer.vDomPadLeft)), (n -= parseInt(this.table.columnManager.renderer.vDomPadLeft))),
			...
			if (!this.currentCell) {
				...
				if ((t && t.stopPropagation(), this.allowEdit(e) || i)) {
					if (
						...
						(o = e.getComponent()),
						this.mouseClick && ((this.mouseClick = !1), e.column.definition.cellClick && e.column.definition.cellClick.call(this.table, t, o)),
						...
						(s = e.column.modules.edit.editor.call(
							r,
							o,
							function (e) {
								a = e
							...
							function (t) {
								if (r.currentCell === e && !h) {
									...
									return !0 === i || 'highlight' === r.table.options.validationMode
										? ((h = !0), r.clearEditor(), e.modules.edit || (e.modules.edit = {}), (e.modules.edit.edited = !0), -1 == r.editedCells.indexOf(e) && r.editedCells.push(e), (t = r.transformEmptyValues(t, e)), e.setValue(t, !0), !0 === i)
										: ((h = !0),
										  (r.invalidEdit = !0),
	...
	class de extends M {
		...
		generateExportList(e, t, i, s) {
			var o, n, r, a
			return (this.cloneTableStyle = t), (this.config = e || {}), (this.colVisProp = s), (this.colVisPropAttach = this.colVisProp.charAt(0).toUpperCase() + this.colVisProp.slice(1)), (a = de.columnLookups[i]) && (r = (r = a.call(this.table)).filter(e => this.columnVisCheck(e))), (o = !1 !== this.config.columnHeaders ? this.headersToExportRows(this.generateColumnGroupHeaders(r)) : []), r && (r = r.map(e => e.getComponent())), (n = this.bodyToExportRows(this.rowLookup(i), r)), o.concat(n)
		}
		...
		rowLookup(e) {
			...
			return (
				'function' == typeof e
					? e.call(this.table).forEach(e => {
							;(e = this.table.rowManager.findRow(e)) && i.push(e)
					  })
					: ((t = de.rowLookups[e] || de.rowLookups.active), (i = t.call(this.table))),
				Object.assign([], i)
			)
		}
		generateColumnGroupHeaders(e) {
			var t = []
			return (
				e || (e = !1 !== this.config.columnGroups ? this.table.columnManager.columns : this.table.columnManager.columnsByIndex),
				e.forEach(e => {
		...
		processColumnGroup(e) {
			var t = e.columns,
				i = 0,
				s = { title: e.definition['title' + this.colVisPropAttach] || e.definition.title, column: e, depth: 1 }
			if (t.length) {
				if (
					((s.subGroups = []),
					(s.width = 0),
		...
		bodyToExportRows(e, t = []) {
			...
			return (
				...
				!1 !== this.config.columnCalcs && this.table.modExists('columnCalcs') && (this.table.modules.columnCalcs.topInitialized && e.unshift(this.table.modules.columnCalcs.topRow), this.table.modules.columnCalcs.botInitialized && e.push(this.table.modules.columnCalcs.botRow)),
				(e = e.filter(e => {
					switch (e.type) {
						case 'group':
					...
					switch (e.type) {
						case 'group':
							;(r = e.level), n.push(new ae(e.key, e.getComponent(), t.length, 1))
							break
						case 'calc':
						case 'row':
							t.forEach(e => {
		...
		generateTableElement(e) {
			var t = document.createElement('table'),
				...
				r = {}
			return (
				(r.rowFormatter = null !== n ? n : this.table.options.rowFormatter),
		...
		lookupTableStyles() {
			...
			return (
				this.cloneTableStyle &&
					...
					((e.oddRow = this.table.element.querySelector('.tabulator-row-odd:not(.tabulator-group):not(.tabulator-calcs)')),
					...
					e.firstRow && ((e.styleCells = e.firstRow.getElementsByClassName('tabulator-cell')), (e.styleRowHeader = e.firstRow.getElementsByClassName('tabulator-row-header')[0]), (e.firstCell = e.styleCells[0]), (e.lastCell = e.styleCells[e.styleCells.length - 1]))),
				e
			)
		}
			...
			if (
				...
				e.columns.forEach((o, n) => {
					if (o) {
						...
						if (
							((h.definition.cssClass ? h.definition.cssClass.split(' ') : []).forEach(function (e) {
								l.classList.add(e)
							}),
						...
						u instanceof Node ? l.appendChild(u) : (l.innerHTML = u),
							...
							h.isRowHeader ? ((r = i.styleRowHeader), a.push('background-color')) : (r = i.styleCells && i.styleCells[c] ? i.styleCells[c] : i.firstCell),
							r && (this.mapElementStyles(r, l, a), h.definition.align && (l.style.textAlign = h.definition.align)),
							this.table.options.dataTree && !1 !== this.config.dataTree && ((t.treeElementField && t.treeElementField == h.field) || (!t.treeElementField && 0 == n)) && (e.component._row.modules.dataTree.controlEl && l.insertBefore(e.component._row.modules.dataTree.controlEl.cloneNode(!0), l.firstChild), e.component._row.modules.dataTree.branchEl && l.insertBefore(e.component._row.modules.dataTree.branchEl.cloneNode(!0), l.firstChild)),
							s.appendChild(l),
	...
	class ue extends M {
		...
		tableBuilt() {
			this.table.options.initialFilter && this.setFilter(this.table.options.initialFilter),
				this.table.options.initialHeaderFilter &&
					this.table.options.initialHeaderFilter.forEach(e => {
					...
					if (void 0 === e.modules.filter.prevSuccess || e.modules.filter.prevSuccess !== t) {
						if (((e.modules.filter.prevSuccess = t), e.modules.filter.emptyFunc(t))) delete i.headerFilters[s]
							...
							switch (((e.modules.filter.value = t), typeof e.definition.headerFilterFunc)) {
								case 'string':
									ue.filters[e.definition.headerFilterFunc]
										? ((r = e.definition.headerFilterFunc),
										  (o = function (i) {
												var s = e.definition.headerFilterFuncParams || {},
													o = e.getFieldValue(i)
												return (s = 'function' == typeof s ? s(t, o, i) : s), ue.filters[e.definition.headerFilterFunc](t, o, i, s)
										  }))
							...
							if (!o)
								if ('partial' === n)
									...
									(o = function (i) {
										...
										(r = '=')
							i.headerFilters[s] = { value: t, func: o, type: r }
						}
		...
		generateHeaderFilterElement(e, t, i) {
			...
			if (((e.modules.filter.value = t), e.modules.filter.headerElement && e.modules.filter.headerElement.parentNode && e.contentElement.removeChild(e.modules.filter.headerElement.parentNode), m)) {
				switch (
					...
					case 'string':
						c.table.modules.edit.editors[e.definition.headerFilter]
							? ((o = c.table.modules.edit.editors[e.definition.headerFilter]),
							  ('tick' !== e.definition.headerFilter && 'tickCross' !== e.definition.headerFilter) ||
									e.definition.headerFilterEmptyCheck ||
					...
					case 'boolean':
						e.modules.edit && e.modules.edit.editor
							? (o = e.modules.edit.editor)
							: e.definition.formatter && c.table.modules.edit.editors[e.definition.formatter]
							? ((o = c.table.modules.edit.editors[e.definition.formatter]),
							  ('tick' !== e.definition.formatter && 'tickCross' !== e.definition.formatter) ||
									e.definition.headerFilterEmptyCheck ||
									(e.modules.filter.emptyFunc = function (e) {
										return !0 !== e && !1 !== e
									}))
					...
					c.langBind('headerFilters|columns|' + e.definition.field, function (t) {
						...
						!1 !== e.definition.headerFilterLiveFilter &&
							('autocomplete' !== e.definition.headerFilter &&
								...
								(('autocomplete' !== e.definition.editor && 'tickCross' !== e.definition.editor) || !0 !== e.definition.headerFilter) &&
							...
							('input' != e.modules.filter.tagType && 'select' != e.modules.filter.tagType && 'textarea' != e.modules.filter.tagType) ||
		...
		addFilter(e, t, i, s) {
			var o = !1
			Array.isArray(e) || (e = [{ field: e, type: t, value: i, params: s }]),
				e.forEach(e => {
		...
		findFilter(e) {
			...
			return (
				'function' == typeof e.field
					...
					: ue.filters[e.type]
					? (i = (t = this.table.columnManager.getColumnByField(e.field))
							? function (i) {
		...
		filtersToArray(e, t) {
			...
			return (
				e.forEach(e => {
					var s
					Array.isArray(e) ? i.push(this.filtersToArray(e, t)) : ((s = { field: e.field, type: e.type, value: e.value }), t && 'function' == typeof s.type && (s.type = 'function'), i.push(s))
				}),
				i
			)
		}
		...
		search(e, t, i, s) {
			var o = [],
				n = []
			return (
				Array.isArray(t) || (t = [{ field: t, type: i, value: s }]),
				t.forEach(e => {
	...
	var me = {
		...
		link: function (e, t, i) {
			...
			if (l) {
				if ((t.urlField && ((s = e.getData()), (o = a.retrieveNestedData(this.table.options.nestedFieldSeparator, t.urlField, s))), t.url))
					switch (typeof t.url) {
						case 'string':
							o = t.url
							break
		...
		toggle: function (e, t, i) {
			var s,
				...
				d = t.onTruthy ? n : n === l
			return (
				(s = document.createElement('div')).classList.add('tabulator-toggle'),
				d ? (s.classList.add('tabulator-toggle-on'), (s.style.flexDirection = 'row-reverse'), t.onColor && (s.style.background = t.onColor)) : t.offColor && (s.style.background = t.offColor),
	...
	class pe extends M {
		...
		lookupFormatter(e, t) {
			...
			switch (typeof s) {
				case 'string':
					pe.formatters[s] ? (i.formatter = pe.formatters[s]) : (console.warn('Formatter Error - No such formatter found: ', s), (i.formatter = pe.formatters.plaintext))
					break
				case 'function':
					i.formatter = s
					break
		...
		formatHeader(e, t, i) {
			var s, o, n, r
			return e.definition.titleFormatter
				? ((s = this.getFormatter(e.definition.titleFormatter)),
				  (n = t => {
		...
		getFormatter(e) {
			switch (typeof e) {
				case 'string':
					pe.formatters[e] ? (e = pe.formatters[e]) : (console.warn('Formatter Error - No such formatter found: ', e), (e = pe.formatters.plaintext))
					break
				case 'function':
					break
				default:
	...
	class be {
		...
		createValueGroups() {
			...
			this.groupManager.allowedValues &&
				this.groupManager.allowedValues[e] &&
				this.groupManager.allowedValues[e].forEach(t => {
					this._createGroup(t, e)
				})
		}
		addBindings() {
			this.groupManager.table.options.groupToggleElement &&
				('arrow' == this.groupManager.table.options.groupToggleElement ? this.arrowElement : this.element).addEventListener('click', e => {
					'arrow' === this.groupManager.table.options.groupToggleElement && (e.stopPropagation(), e.stopImmediatePropagation()),
						setTimeout(() => {
		...
		removeRow(e) {
			...
			t > -1 && this.rows.splice(t, 1),
				this.groupManager.table.options.groupValues || this.rows.length ? (i.parentNode && i.parentNode.removeChild(i), this.groupManager.blockRedraw || (this.generateGroupHeaderContents(), this.groupManager.table.modExists('columnCalcs') && 'table' != this.groupManager.table.options.columnCalcs && this.groupManager.table.modules.columnCalcs.recalcGroup(this))) : (this.parent ? this.parent.removeGroup(this) : this.groupManager.removeGroup(this), this.groupManager.updateGroupRows(!0))
		}
		removeGroup(e) {
			var t,
				i = e.level + '_' + e.key
			...
			return (
				...
				this.visible
					? this.groupList.length
						...
						: ('table' != this.groupManager.table.options.columnCalcs && this.groupManager.table.modExists('columnCalcs') && this.groupManager.table.modules.columnCalcs.hasTopCalcs() && ((this.calcs.top = this.groupManager.table.modules.columnCalcs.generateTopRow(this.rows)), e.push(this.calcs.top)),
						  (e = e.concat(this.rows)),
						  'table' != this.groupManager.table.options.columnCalcs && this.groupManager.table.modExists('columnCalcs') && this.groupManager.table.modules.columnCalcs.hasBottomCalcs() && ((this.calcs.bottom = this.groupManager.table.modules.columnCalcs.generateBottomRow(this.rows)), e.push(this.calcs.bottom)))
					: this.groupList.length ||
					  'table' == this.groupManager.table.options.columnCalcs ||
					  (this.groupManager.table.modExists('columnCalcs') &&
							(this.groupManager.table.modules.columnCalcs.hasTopCalcs() && this.groupManager.table.options.groupClosedShowCalcs && ((this.calcs.top = this.groupManager.table.modules.columnCalcs.generateTopRow(this.rows)), e.push(this.calcs.top)),
							this.groupManager.table.modules.columnCalcs.hasBottomCalcs() && this.groupManager.table.options.groupClosedShowCalcs && ((this.calcs.bottom = this.groupManager.table.modules.columnCalcs.generateBottomRow(this.rows)), e.push(this.calcs.bottom)))),
				e
			)
		}
		getData(e, t) {
		...
		generateGroupHeaderContents() {
			var e = []
			for (
				this.getRows(!1, !0).forEach(function (t) {
					e.push(t.getData())
				}),
					this.elementContents = this.generator(this.key, this.getRowCount(), e, this.getComponent());
	...
	var fe = {
		...
		we = {
			keybindings: {
				bindings: { undo: ['ctrl + 90', 'meta + 90'], redo: ['ctrl + 89', 'meta + 89'] },
				actions: {
					undo: function (e) {
	...
	class Ce extends M {
		...
		initialize() {
			this.table.options.history && (this.subscribe('cell-value-updated', this.cellUpdated.bind(this)), this.subscribe('cell-delete', this.clearComponentHistory.bind(this)), this.subscribe('row-delete', this.rowDeleted.bind(this)), this.subscribe('rows-wipe', this.clear.bind(this)), this.subscribe('row-added', this.rowAdded.bind(this)), this.subscribe('row-move', this.rowMoved.bind(this))),
		...
		rowDeleted(e) {
			var t, i
			this.table.options.groupBy ? (t = (i = e.getComponent().getGroup()._getSelf().rows).indexOf(e)) && (t = i[t - 1]) : (t = e.table.rowManager.getRowIndex(e)) && (t = e.table.rowManager.rows[t - 1]), this.action('rowDelete', e, { data: e.getData(), pos: !t, index: t })
		}
		cellUpdated(e) {
		...
		action(e, t, i) {
			;(this.history = this.history.slice(0, this.index + 1)), this.history.push({ type: e, component: t, data: i }), this.index++
		}
		getHistoryUndoSize() {
			return this.index + 1
		}
		...
		undo() {
			if (this.index > -1) {
				...
				return Ce.undoers[e.type].call(this, e), this.index--, this.dispatchExternal('historyUndo', e.type, e.component.getComponent(), e.data), !0
			}
		...
		redo() {
			if (this.history.length - 1 > this.index) {
				this.index++
				let e = this.history[this.index]
				return Ce.redoers[e.type].call(this, e), this.dispatchExternal('historyRedo', e.type, e.component.getComponent(), e.data), !0
			}
	...
	class ye extends M {
		...
		loadData(e, t, i, s, o) {
			return this.importData(this.lookupImporter(), e)
				.then(this.structureData.bind(this))
				.catch(e => (console.error('Import Error:', e || 'Unable to import data'), Promise.reject(e)))
		}
		lookupImporter(e) {
			var t
			return e || (e = this.table.options.importFormat), (t = 'string' == typeof e ? ye.importers[e] : e) || console.error('Import Error - Importer not found:', e), t
		}
		importFromFile(e, t, i) {
			var s = this.lookupImporter(e)
			if (s)
				return this.pickFile(t, i)
					.then(this.importData.bind(this, s))
					.then(this.structureData.bind(this))
					.then(this.setData.bind(this))
					.catch(e => (this.dispatch('import-error', e), this.dispatchExternal('importError', e), console.error('Import Error:', e || 'Unable to import file'), Promise.reject(e)))
		}
		pickFile(e, t) {
				...
				;(o.type = 'file'),
					...
					o.addEventListener('change', e => {
						...
						;(r.onload = e => {
							...
							(r.onerror = e => {
								console.warn('File Load Error - Unable to read file'), s()
							})
					}),
		...
		structureArrayToColumns(e) {
			...
			return (
				i[0] && e[0][0] && i[0].getDefinition().title === e[0][0] && e.shift(),
				e.forEach(e => {
					var s = {}
					e.forEach((e, t) => {
						var o = i[t]
		...
		setData(e) {
			return this.dispatch('import-imported', e), this.dispatchExternal('importImported', e), this.table.setData(e)
		}
	}
	var Re = { navPrev: 'shift + 9', navNext: 9, navUp: 38, navDown: 40, navLeft: 37, navRight: 39, scrollPageUp: 33, scrollPageDown: 34, scrollToStart: 36, scrollToEnd: 35 },
		xe = {
			keyBlock: function (e) {
	...
	class Te extends M {
		...
		initialize() {
			var e = this.table.options.keybindings,
				t = {}
			;(this.watchKeys = {}), (this.pressedKeys = []), !1 !== e && (Object.assign(t, Te.bindings), Object.assign(t, e), this.mapBindings(t), this.bindEvents()), this.subscribe('table-destroy', this.clearBindings.bind(this))
		}
		mapBindings(e) {
			for (let t in e)
				Te.actions[t]
					? e[t] &&
					  ('object' != typeof e[t] && (e[t] = [e[t]]),
					  e[t].forEach(e => {
		...
		mapBinding(e, t) {
			var i = { action: Te.actions[e], keys: [], ctrl: !1, shift: !1, meta: !1 }
			t.toString()
				.toLowerCase()
				.split(' ')
				.join('')
	...
	class Le extends M {
			...
			t.addEventListener(
				...
				t.addEventListener('touchmove', t => {
					...
					this.moving &&
						...
						(h = t.touches[0].pageY - l) > 0 ? i && h - r > o && (d = i) !== e && ((l = t.touches[0].pageY), d.getElement().parentNode.insertBefore(this.placeholderElement, d.getElement().nextSibling), this.moveRow(d, !0)) : s && -h - a > n && (d = s) !== e && ((l = t.touches[0].pageY), d.getElement().parentNode.insertBefore(this.placeholderElement, d.getElement()), this.moveRow(d, !1)),
						d && ((i = d.nextRow()), (r = o), (o = i ? i.getHeight() / 2 : 0), (s = d.prevRow()), (a = n), (n = s ? s.getHeight() / 2 : 0)))
				}),
		...
		startMove(e, t) {
			...
			this.setStartPosition(e, t),
				...
				this.connection ? (this.table.element.classList.add('tabulator-movingrow-sending'), this.connectToTables(t)) : (i.parentNode.insertBefore(this.placeholderElement, i), i.parentNode.removeChild(i)),
				(this.hoverElement = i.cloneNode(!0)),
				this.hoverElement.classList.add('tabulator-moving'),
				this.connection
					? (document.body.appendChild(this.hoverElement), (this.hoverElement.style.left = '0'), (this.hoverElement.style.top = '0'), (this.hoverElement.style.width = this.table.element.clientWidth + 'px'), (this.hoverElement.style.whiteSpace = 'nowrap'), (this.hoverElement.style.overflow = 'hidden'), (this.hoverElement.style.pointerEvents = 'none'))
		...
		connectToTables(e) {
			var t
			this.connectionSelectorsTables && ((t = this.commsConnections(this.connectionSelectorsTables)), this.dispatchExternal('movableRowsSendingStart', t), this.commsSend(this.connectionSelectorsTables, 'moveRow', 'connect', { row: e })),
		...
		disconnectFromTables() {
			var e
			this.connectionSelectorsTables && ((e = this.commsConnections(this.connectionSelectorsTables)), this.dispatchExternal('movableRowsSendingStop', e), this.commsSend(this.connectionSelectorsTables, 'moveRow', 'disconnect')),
				this.connectionElements.forEach(e => {
		...
		disconnect(e) {
			e === this.connectedTable
				? ((this.connectedTable = !1),
				  ...
				  this.dispatchExternal('movableRowsReceivingStop', e))
		...
		tableRowDrop(e, t) {
			...
			i ? (s = i.call(this, this.connectedRow.getComponent(), t ? t.getComponent() : void 0, this.connectedTable)) : console.warn('Mover Row Error - no matching receiver found:', this.table.options.movableRowsReceiver),
				...
				this.commsSend(this.connectedTable, 'moveRow', 'dropcomplete', { row: t, success: s })
		}
		commsReceived(e, t, i) {
			switch (t) {
				case 'connect':
	...
	class De extends M {
		...
		initializeColumn(e) {
			...
			this.allowedTypes.forEach(s => {
				...
				e.definition[n] && (o = this.lookupMutator(e.definition[n])) && ((t = !0), (i[n] = { mutator: o, params: e.definition[n + 'Params'] || {} }))
			}),
		...
		transformRow(e, t, i) {
			...
			return (
				this.enabled &&
					this.table.columnManager.traverse(n => {
						var r, a, l
	...
	var ze = {
		rows: function (e, t, i, s, o) {
			...
			return (
				this.table.modules.localize.langBind('pagination|counter|showing', e => {
					r.innerHTML = e
				}),
				...
				s ? ((a.innerHTML = ' ' + t + '-' + Math.min(t + e - 1, s) + ' '), (h.innerHTML = ' ' + s + ' '), n.appendChild(r), n.appendChild(a), n.appendChild(l), n.appendChild(h), n.appendChild(d)) : ((a.innerHTML = ' 0 '), n.appendChild(r), n.appendChild(a), n.appendChild(d)),
				n
			)
		},
	...
	class Pe extends M {
		...
		initialize() {
			this.table.options.pagination
				...
				: this.table.options.progressiveLoad &&
				  (this.subscribe('data-params', this.remotePageParams.bind(this)), this.subscribe('data-loaded', this._parseRemoteData.bind(this)), this.subscribe('table-built', this.calculatePageSizes.bind(this)), this.subscribe('data-processed', this.initialLoadComplete.bind(this)), this.initializeProgressive(this.table.options.progressiveLoad), 'scroll' === this.table.options.progressiveLoad && this.subscribe('scroll-vertical', this.scrollVertical.bind(this)))
		}
		rowAddingPosition(e, t) {
			var i,
				s = this.table.rowManager,
				o = s.getDisplayRows()
			return t ? (o.length ? (i = o[0]) : s.activeRows.length && ((i = s.activeRows[s.activeRows.length - 1]), (t = !1))) : o.length && ((i = o[o.length - 1]), (t = !(o.length < this.size))), { index: i, top: t }
		}
		calculatePageSizes() {
			var e, t
			this.table.options.paginationSize
				? (this.size = this.table.options.paginationSize)
				: ((e = document.createElement('div')).classList.add('tabulator-row'), (e.style.visibility = 'hidden'), (t = document.createElement('div')).classList.add('tabulator-cell'), (t.innerHTML = 'Page Row Test'), e.appendChild(t), this.table.rowManager.getTableElement().appendChild(e), (this.size = Math.floor(this.table.rowManager.getElement().clientHeight / e.offsetHeight)), this.table.rowManager.getTableElement().removeChild(e)),
		...
		generatePageSizeSelectList() {
			...
			if (this.pageSizeSelect) {
				...
				e.forEach(e => {
					...
					;(t.value = e),
						!0 === e
							? this.langBind('pagination|all', function (e) {
									t.innerHTML = e
							  })
							: (t.innerHTML = e),
		...
		initializePageCounter() {
			var e = this.table.options.paginationCounter,
				t = null
			e && ((t = 'function' == typeof e ? e : Pe.pageCounters[e]) ? ((this.pageCounter = t), (this.pageCounterElement = document.createElement('span')), this.pageCounterElement.classList.add('tabulator-page-counter')) : console.warn('Pagination Error - No such page counter found: ', e))
		}
		initializePaginator(e) {
			var t, i
			e ||
				(this.langBind('pagination|first', e => {
					...
					(this.table.options.paginationCounter &&
						(this.table.options.paginationCounterElement
							? this.table.options.paginationCounterElement instanceof HTMLElement
								...
								: 'string' == typeof this.table.options.paginationCounterElement && ((i = document.querySelector(this.table.options.paginationCounterElement)) ? i.appendChild(this.pageCounterElement) : console.warn('Pagination Error - Unable to find element matching paginationCounterElement selector:', this.table.options.paginationCounterElement))
		...
		_setPageCounter(e, t, i) {
			var s
			if (this.pageCounter)
				switch (('remote' === this.mode && ((t = this.size), (i = (this.page - 1) * this.size + 1), (e = this.remoteRowCountEstimate)), typeof (s = this.pageCounter.call(this, t, i, this.page, e, this.max)))) {
					case 'object':
		...
		_generatePageButton(e) {
			...
			return (
				t.classList.add('tabulator-page'),
					...
					switch (this.mode) {
						...
						case 'progressive_scroll':
							;(e = 1 === this.page ? e.data : this.table.rowManager.getData().concat(e.data)),
								...
								this.table.rowManager.element.scrollHeight <= this.table.rowManager.element.clientHeight + t &&
									this.page < this.max &&
									setTimeout(() => {
										this.nextPage()
									})
				...
				;(this.mode = !0 !== t ? t : this.localStorageTest() ? 'local' : 'cookie'),
					this.table.options.persistenceReaderFunc
						? 'function' == typeof this.table.options.persistenceReaderFunc
							...
							: _e.readers[this.table.options.persistenceReaderFunc]
							? (this.readFunc = _e.readers[this.table.options.persistenceReaderFunc])
							: console.warn('Persistence Read Error - invalid reader set', this.table.options.persistenceReaderFunc)
						: _e.readers[this.mode]
						? (this.readFunc = _e.readers[this.mode])
						: console.warn('Persistence Read Error - invalid reader set', this.mode),
					this.table.options.persistenceWriterFunc
						? 'function' == typeof this.table.options.persistenceWriterFunc
							? (this.writeFunc = this.table.options.persistenceWriterFunc)
							: _e.writers[this.table.options.persistenceWriterFunc]
							? (this.writeFunc = _e.writers[this.table.options.persistenceWriterFunc])
							: console.warn('Persistence Write Error - invalid reader set', this.table.options.persistenceWriterFunc)
						: _e.writers[this.mode]
						? (this.writeFunc = _e.writers[this.mode])
					...
					this.config.page && (e = this.retrieveData('page')) && (void 0 === e.paginationSize || (!0 !== this.config.page && !this.config.page.size) || (this.table.options.paginationSize = e.paginationSize), void 0 === e.paginationInitialPage || (!0 !== this.config.page && !this.config.page.page) || (this.table.options.paginationInitialPage = e.paginationInitialPage)),
					this.config.group && (e = this.retrieveData('group')) && (void 0 === e.groupBy || (!0 !== this.config.group && !this.config.group.groupBy) || (this.table.options.groupBy = e.groupBy), void 0 === e.groupStartOpen || (!0 !== this.config.group && !this.config.group.groupStartOpen) || (this.table.options.groupStartOpen = e.groupStartOpen), void 0 === e.groupHeader || (!0 !== this.config.group && !this.config.group.groupHeader) || (this.table.options.groupHeader = e.groupHeader)),
					this.config.columns && ((this.table.options.columns = this.load('columns', this.table.options.columns)), this.subscribe('column-init', this.initializeColumn.bind(this)), this.subscribe('column-show', this.save.bind(this, 'columns')), this.subscribe('column-hide', this.save.bind(this, 'columns')), this.subscribe('column-moved', this.save.bind(this, 'columns'))),
		...
		mergeDefinition(e, t, i) {
			...
			return (
				(t = t || []).forEach((t, o) => {
					...
					r &&
						(i ? (n = Object.keys(t)) : !0 === this.config.columns || null == this.config.columns ? (n = Object.keys(r)).push('width') : (n = this.config.columns),
						n.forEach(e => {
			...
			return (
				e.forEach(e => {
					var s,
						...
						n = e.getDefinition()
					e.isGroup
						? ((o.title = n.title), (o.columns = this.parseColumns(e.getColumns())))
						: ((o.field = e.getField()),
						  !0 === this.config.columns || null == this.config.columns ? ((s = Object.keys(n)).push('width'), s.push('visible')) : (s = this.config.columns),
						  s.forEach(t => {
								switch (t) {
									case 'width':
										o.width = e.getWidth()
		...
		format: {
			formatters: {
				responsiveCollapse: function (e, t, i) {
					...
					return (
						s.classList.add('tabulator-responsive-collapse-toggle'),
						(s.innerHTML =
						...
						if (
							...
							n instanceof m
								? (s.addEventListener('change', e => {
								  ...
								  'click' === this.table.options.selectableRowsRangeMode &&
										s.addEventListener('click', e => {
											;(o = !0), this.table.modules.selectRow.handleComplexRowClick(n._row, e)
										}),
								  (s.checked = n.isSelected && n.isSelected()),
								  this.table.modules.selectRow.registerRowSelectCheckbox(n, s))
								: (s = '')
						} else
							s.addEventListener('change', e => {
	...
	class Ve extends t {
		constructor(e, t, i, s) {
			super(e),
				...
				(this.element = null),
				(this.initialized = !1),
				(this.initializing = { start: !1, end: !1 }),
				(this.destroyed = !1),
				(this.top = 0),
				(this.bottom = 0),
				(this.left = 0),
				...
				this.rangeManager.rowHeader && ((this.left = 1), (this.right = 1), (this.start.col = 1), (this.end.col = 1)),
				this.initElement(),
				setTimeout(() => {
					this.initBounds(i, s)
				})
		...
		setEndBound(e) {
			...
			'column' === e.type
				? this.rangeManager.columnSelection && ('column' === this.rangeManager.selecting ? this.setEnd(o - 1, e.getPosition() - 1) : 'cell' === this.rangeManager.selecting && this.setEnd(0, e.getPosition() - 1))
				: ((t = e.row.position - 1), (i = e.column.getPosition() - 1), (s = e.column === this.rangeManager.rowHeader), 'row' === this.rangeManager.selecting ? this.setEnd(t, this._getTableColumns().length - 1) : 'row' !== this.rangeManager.selecting && s ? this.setEnd(t, 0) : 'column' === this.rangeManager.selecting ? this.setEnd(o - 1, i) : this.setEnd(t, i))
		}
		_updateMinMax() {
		...
		layout() {
			...
			'virtual' === this.table.options.renderHorizontal && this.rangeManager.rowHeader && (m += 1),
				...
				null == u && (u = 0),
				null == m && (m = 1 / 0),
				this.overlaps(u, d, m, c) &&
					((e = Math.max(this.top, d)),
					...
					this.table.rtl ? ((this.element.style.right = l.offsetWidth - r.offsetLeft - r.offsetWidth + 'px'), (this.element.style.width = r.offsetLeft + r.offsetWidth - a.offsetLeft + 'px')) : ((this.element.style.left = l.offsetLeft + r.offsetLeft + 'px'), (this.element.style.width = a.offsetLeft + a.offsetWidth - r.offsetLeft + 'px')),
			...
			pasteActions: {
				range: function (e) {
					...
					return (
						(n = e.length),
						a &&
							((i = (t = a.getBounds()).start),
							t.start === t.end && (l = !0),
							i &&
								((s = (r = this.table.rowManager.activeRows.slice()).indexOf(i.row)),
			...
			pasteParsers: {
				range: function (e) {
					...
					return (
						!!(
							l &&
							((i = (t = l.getBounds()).start),
							t.start === t.end && (h = !0),
							i &&
								((e = e.split('\n')).forEach(function (e) {
									r.push(e.split('\t'))
								}),
								r.length && (n = (o = this.table.columnManager.getVisibleColumnsByIndex()).indexOf(i.column)) > -1))
						) &&
						((s = h ? r[0].length : o.indexOf(t.end.column) - n + 1),
						(o = o.slice(n, n + s)),
						r.forEach(e => {
							var t = {},
								i = e.length
	...
	var We = {
		...
		date: function (e, t, i, s, o, n, r) {
			return r.format || (r.format = 'dd/MM/yyyy'), Ne.call(this, e, t, i, s, o, n, r)
		},
		time: function (e, t, i, s, o, n, r) {
			return r.format || (r.format = 'HH:mm'), Ne.call(this, e, t, i, s, o, n, r)
		},
		datetime: Ne,
	...
	class je extends M {
		...
		initializeColumn(e) {
			...
			if (((e.modules.sort = { sorter: s, dir: 'none', params: e.definition.sorterParams || {}, startingDir: e.definition.headerSortStartingDir || 'asc', tristate: e.definition.headerSortTristate }), !1 !== e.definition.headerSort)) {
				...
				e.titleHolderElement.appendChild(i),
					...
					('icon' === this.table.options.headerSortClickElement ? i : t).addEventListener('click', t => {
						...
						if (e.modules.sort) {
							...
							this.table.options.columnHeaderSortMulti && (t.shiftKey || t.ctrlKey) ? ((o = (s = this.getSort()).findIndex(t => t.field === e.getField())), o > -1 ? ((s[o].dir = i), (o = s.splice(o, 1)[0]), 'none' != i && s.push(o)) : 'none' != i && s.push({ column: e, dir: i }), this.setSort(s)) : 'none' == i ? this.clear() : this.setSort(e, i), this.refreshSort()
						}
					})
			}
		}
		...
		sort(e, t) {
			var i = this,
				...
				n = []
			return (
				this.subscribedExternal('dataSorting') && this.dispatchExternal('dataSorting', i.getSort()),
	...
	class Xe extends t {
		constructor(e, t) {
			super(e.table),
				...
				(this.defaultColumnDefinition = { width: 100, headerHozAlign: 'center', headerSort: !1 }),
		...
		getData(e) {
			...
			return (
				...
				e || this.options('spreadsheetOutputFull') || ((t = o.map(e => e.findLastIndex(e => void 0 !== e) + 1)), (i = Math.max(...t)), (s = t.findLastIndex(e => e > 0) + 1), (o = (o = o.slice(0, s)).map(e => e.slice(0, i)))),
				o
			)
		}
		setData(e) {
	...
	class qe extends M {
		...
		initializeColumn(e) {
			...
			e.definition.validator &&
				(Array.isArray(e.definition.validator)
					? e.definition.validator.forEach(e => {
		...
		_buildValidator(e, t) {
			...
			return i ? { type: 'function' == typeof e ? 'function' : e, func: i, params: t } : (console.warn('Validator Setup Error - No matching validator found:', e), !1)
		}
		validate(e, t, i) {
			var s = this,
				o = [],
			...
			return (
				e &&
					e.forEach(e => {
						e.func.call(s, t.getComponent(), i, e.params) || o.push({ type: e.type, parameters: e.params })
					}),
				t.modules.validate || (t.modules.validate = {}),
				o.length ? ((t.modules.validate.invalid = o), 'manual' !== this.table.options.validationMode && t.getElement().classList.add('tabulator-validation-fail'), -1 == n && this.invalidCells.push(t)) : ((t.modules.validate.invalid = !1), t.getElement().classList.remove('tabulator-validation-fail'), n > -1 && this.invalidCells.splice(n, 1)),
				!o.length || o
			)
		}
		getInvalidCells() {
	...
	var Ke = Object.freeze({
		...
		DataTreeModule: class extends M {
			...
			initialize() {
				if (this.table.options.dataTree) {
					...
					switch (
						((this.field = t.dataTreeChildField),
						...
						t.dataTreeBranchElement
							? !0 === t.dataTreeBranchElement
								? ((this.branchEl = document.createElement('div')), this.branchEl.classList.add('tabulator-data-tree-branch'))
								: 'string' == typeof t.dataTreeBranchElement
								? (((e = document.createElement('div')).innerHTML = t.dataTreeBranchElement), (this.branchEl = e.firstChild))
								: (this.branchEl = t.dataTreeBranchElement)
							: ((this.branchEl = document.createElement('div')), this.branchEl.classList.add('tabulator-data-tree-branch-empty')),
						t.dataTreeCollapseElement ? ('string' == typeof t.dataTreeCollapseElement ? (((e = document.createElement('div')).innerHTML = t.dataTreeCollapseElement), (this.collapseEl = e.firstChild)) : (this.collapseEl = t.dataTreeCollapseElement)) : ((this.collapseEl = document.createElement('div')), this.collapseEl.classList.add('tabulator-data-tree-control'), (this.collapseEl.tabIndex = 0), (this.collapseEl.innerHTML = "<div class='tabulator-data-tree-control-collapse'></div>")),
						t.dataTreeExpandElement ? ('string' == typeof t.dataTreeExpandElement ? (((e = document.createElement('div')).innerHTML = t.dataTreeExpandElement), (this.expandEl = e.firstChild)) : (this.expandEl = t.dataTreeExpandElement)) : ((this.expandEl = document.createElement('div')), this.expandEl.classList.add('tabulator-data-tree-control'), (this.expandEl.tabIndex = 0), (this.expandEl.innerHTML = "<div class='tabulator-data-tree-control-expand'></div>")),
			...
			initializeRow(e) {
				...
				!s && e.modules.dataTree && e.modules.dataTree.branchEl && e.modules.dataTree.branchEl.parentNode.removeChild(e.modules.dataTree.branchEl),
					...
					(e.modules.dataTree = { index: e.modules.dataTree ? e.modules.dataTree.index : 0, open: !!s && (e.modules.dataTree ? e.modules.dataTree.open : this.startOpen(e.getComponent(), 0)), controlEl: !(!e.modules.dataTree || !s) && e.modules.dataTree.controlEl, branchEl: !(!e.modules.dataTree || !s) && e.modules.dataTree.branchEl, parent: !!e.modules.dataTree && e.modules.dataTree.parent, children: s })
			}
			...
			layoutRow(e) {
				...
				i.branchEl && (i.branchEl.parentNode && i.branchEl.parentNode.removeChild(i.branchEl), (i.branchEl = !1)),
					...
					i.index &&
						(this.branchEl
							? ((i.branchEl = this.branchEl.cloneNode(!0)), t.insertBefore(i.branchEl, t.firstChild), this.table.rtl ? (i.branchEl.style.marginRight = (i.branchEl.offsetWidth + i.branchEl.style.marginLeft) * (i.index - 1) + i.index * this.indent + 'px') : (i.branchEl.style.marginLeft = (i.branchEl.offsetWidth + i.branchEl.style.marginRight) * (i.index - 1) + i.index * this.indent + 'px'))
							: this.table.rtl
							? (t.style.paddingRight = parseInt(window.getComputedStyle(t, null).getPropertyValue('padding-right')) + i.index * this.indent + 'px')
							: (t.style.paddingLeft = parseInt(window.getComputedStyle(t, null).getPropertyValue('padding-left')) + i.index * this.indent + 'px'))
			}
			...
			getChildren(e, t, i) {
				...
				return (
					!1 !== s.children &&
						(s.open || t) &&
						(Array.isArray(s.children) || (s.children = this.generateChildren(e)),
			...
			getFilteredTreeChildren(e) {
				...
				return (
					t.children &&
						(Array.isArray(t.children) || (t.children = this.generateChildren(e)),
			...
			findChildIndex(e, t) {
				var i = !1
				return (
					'object' == typeof e ? (e instanceof p ? (i = e.data) : e instanceof m ? (i = e._getSelf().data) : 'undefined' != typeof HTMLElement && e instanceof HTMLElement ? t.modules.dataTree && (i = t.modules.dataTree.children.find(t => t instanceof p && t.element === e)) && (i = i.data) : null === e && (i = !1)) : (i = void 0 !== e && t.data[this.field].find(t => t.data[this.table.options.index] == e)),
					i && (Array.isArray(t.data[this.field]) && (i = t.data[this.field].indexOf(i)), -1 == i && (i = !1)),
					i
				)
			}
					...
					s &&
						...
						s.children.forEach(e => {
							e instanceof p &&
								...
								i &&
									this.getTreeChildren(e, t, i).forEach(e => {
										o.push(e)
									}))
						})),
					o
		...
		FrozenRowsModule: class extends M {
			...
			initialize() {
				...
				;(this.rows = []),
					...
					this.table.options.frozenRows && (this.subscribe('data-processed', this.initializeRows.bind(this)), this.subscribe('row-added', this.initializeRow.bind(this)), this.subscribe('table-redrawing', this.resizeHolderWidth.bind(this)), this.subscribe('column-resized', this.resizeHolderWidth.bind(this)), this.subscribe('column-show', this.resizeHolderWidth.bind(this)), this.subscribe('column-hide', this.resizeHolderWidth.bind(this))),
					this.resizeHolderWidth()
			}
			resizeHolderWidth() {
				this.topElement.style.minWidth = this.table.columnManager.headersElement.offsetWidth + 'px'
		...
		GroupRowsModule: class extends M {
					...
					Array.isArray(e) || (e = [e]),
						e.forEach((e, t) => {
							...
							;(i =
								'function' == typeof e
									? e
									: (s = this.table.columnManager.getColumnByField(e))
									? function (e) {
								...
								this.groupIDLookups.push({ field: 'function' != typeof e && e, func: i, values: !!this.allowedValues && this.allowedValues[t] })
						}),
						t && (Array.isArray(t) || (t = [t]), t.forEach(e => {}), (this.startOpen = t)),
				...
				return (
					e.forEach(e => {
						var i = { level: 0, rowCount: 0, headerContent: '' },
							s = []
						e.hasSubGroups
							? ((s = this.pullGroupListData(e.groupList)), (i.level = e.level), (i.rowCount = s.length - e.groupList.length), (i.headerContent = e.generator(e.key, i.rowCount, e.rows, e)), t.push(i), (t = t.concat(s)))
							: ((i.level = e.level),
			...
			getRowGroup(e) {
				var t = !1
				return (
					this.options('dataTree') && (e = this.table.modules.dataTree.getTreeParentRoot(e)),
			...
			generateGroups(e) {
				...
				;(this.groups = {}),
					...
					this.allowedValues && this.allowedValues[0]
						? (this.allowedValues[0].forEach(e => {
			...
			createGroup(e, t, i) {
				var s,
					o = t + '_' + e
				;(i = i || []), (s = new be(this, !1, t, e, this.groupIDLookups[0].field, this.headerGenerator[0], i[o])), (this.groups[o] = s), this.groupList.push(s)
			}
			...
			scrollHeaders(e) {
				this.table.options.groupBy &&
					('virtual' === this.table.options.renderHorizontal && (e -= this.table.columnManager.renderer.vDomPadLeft),
					(e += 'px'),
					this.groupList.forEach(t => {
						t.scrollHeader(e)
					}))
		...
		HtmlTableImportModule: class extends M {
			...
			_extractHeaders(e, t) {
				for (var i = 0; i < e.length; i++) {
					...
					r ? (n = !0) : (r = { title: o.textContent.trim() }), r.field || (r.field = o.textContent.trim().toLowerCase().replaceAll(' ', '_')), (s = o.getAttribute('width')) && !r.width && (r.width = s), this._extractOptions(o, r, this.table.columnManager.optionsList.registeredDefaults), (this.fieldIndex[i] = r.field), r.field == this.table.options.index && (this.hasIndex = !0), n || this.table.options.columns.push(r)
				}
			}
		...
		InteractionModule: class extends M {
			...
			constructor(e) {
				super(e),
					...
					(this.touchWatchers = { row: { tap: null, tapDbl: null, tapHold: null }, cell: { tap: null, tapDbl: null, tapHold: null }, column: { tap: null, tapDbl: null, tapHold: null }, group: { tap: null, tapDbl: null, tapHold: null } }),
			...
			handleTouch(e, t, i, s) {
				...
				switch (('column' === e && (e = 'header'), t)) {
					case 'start':
						...
						break
					case 'end':
						o.tap && ((o.tap = null), this.dispatchEvent(e + 'Tap', i, s)),
							o.tapDbl
								? (clearTimeout(o.tapDbl), (o.tapDbl = null), this.dispatchEvent(e + 'DblTap', i, s))
								: (o.tapDbl = setTimeout(() => {
		...
		MenuModule: class extends M {
			...
			initializeRowWatchers() {
				this.table.options.rowContextMenu && (this.subscribe('row-contextmenu', this.loadMenuEvent.bind(this, this.table.options.rowContextMenu)), this.table.on('rowTapHold', this.loadMenuEvent.bind(this, this.table.options.rowContextMenu))),
			...
			initializeGroupWatchers() {
				this.table.options.groupContextMenu && (this.subscribe('group-contextmenu', this.loadMenuEvent.bind(this, this.table.options.groupContextMenu)), this.table.on('groupTapHold', this.loadMenuEvent.bind(this, this.table.options.groupContextMenu))),
			...
			initializeColumn(e) {
				...
				t.headerContextMenu && !this.columnSubscribers.headerContextMenu && ((this.columnSubscribers.headerContextMenu = this.loadMenuTableColumnEvent.bind(this, 'headerContextMenu')), this.subscribe('column-contextmenu', this.columnSubscribers.headerContextMenu), this.table.on('headerTapHold', this.loadMenuTableColumnEvent.bind(this, 'headerContextMenu'))),
					t.headerClickMenu && !this.columnSubscribers.headerClickMenu && ((this.columnSubscribers.headerClickMenu = this.loadMenuTableColumnEvent.bind(this, 'headerClickMenu')), this.subscribe('column-click', this.columnSubscribers.headerClickMenu)),
					t.headerDblClickMenu && !this.columnSubscribers.headerDblClickMenu && ((this.columnSubscribers.headerDblClickMenu = this.loadMenuTableColumnEvent.bind(this, 'headerDblClickMenu')), this.subscribe('column-dblclick', this.columnSubscribers.headerDblClickMenu)),
					t.headerMenu && this.initializeColumnHeaderMenu(e),
					t.contextMenu && !this.columnSubscribers.contextMenu && ((this.columnSubscribers.contextMenu = this.loadMenuTableCellEvent.bind(this, 'contextMenu')), this.subscribe('cell-contextmenu', this.columnSubscribers.contextMenu), this.table.on('cellTapHold', this.loadMenuTableCellEvent.bind(this, 'contextMenu'))),
					t.clickMenu && !this.columnSubscribers.clickMenu && ((this.columnSubscribers.clickMenu = this.loadMenuTableCellEvent.bind(this, 'clickMenu')), this.subscribe('cell-click', this.columnSubscribers.clickMenu)),
					t.dblClickMenu && !this.columnSubscribers.dblClickMenu && ((this.columnSubscribers.dblClickMenu = this.loadMenuTableCellEvent.bind(this, 'dblClickMenu')), this.subscribe('cell-dblclick', this.columnSubscribers.dblClickMenu))
			}
			initializeColumnHeaderMenu(e) {
				...
				;(t = document.createElement('span')).classList.add('tabulator-header-popup-button'),
					i ? ('function' == typeof i && (i = i(e.getComponent())), i instanceof HTMLElement ? t.appendChild(i) : (t.innerHTML = i)) : (t.innerHTML = '&vellip;'),
					t.addEventListener('click', t => {
					...
					a.addEventListener(
						...
						a => {
							...
							this.moving &&
								...
								(h = a.touches[0].pageX - l) > 0 ? t && h - n > s && (d = t) !== e && ((l = a.touches[0].pageX), d.getElement().parentNode.insertBefore(this.placeholderElement, d.getElement().nextSibling), this.moveColumn(d, !0)) : i && -h - r > o && (d = i) !== e && ((l = a.touches[0].pageX), d.getElement().parentNode.insertBefore(this.placeholderElement, d.getElement()), this.moveColumn(d, !1)),
								d && ((t = d.nextColumn()), (n = s), (s = t ? t.getWidth() / 2 : 0), (i = d.prevColumn()), (r = o), (o = i ? i.getWidth() / 2 : 0)))
						},
						{ passive: !0 }
					),
		...
		PopupModule: class extends M {
			...
			initializeRowWatchers() {
				this.table.options.rowContextPopup && (this.subscribe('row-contextmenu', this.loadPopupEvent.bind(this, this.table.options.rowContextPopup)), this.table.on('rowTapHold', this.loadPopupEvent.bind(this, this.table.options.rowContextPopup))),
			...
			initializeGroupWatchers() {
				this.table.options.groupContextPopup && (this.subscribe('group-contextmenu', this.loadPopupEvent.bind(this, this.table.options.groupContextPopup)), this.table.on('groupTapHold', this.loadPopupEvent.bind(this, this.table.options.groupContextPopup))),
			...
			initializeColumn(e) {
				...
				t.headerContextPopup && !this.columnSubscribers.headerContextPopup && ((this.columnSubscribers.headerContextPopup = this.loadPopupTableColumnEvent.bind(this, 'headerContextPopup')), this.subscribe('column-contextmenu', this.columnSubscribers.headerContextPopup), this.table.on('headerTapHold', this.loadPopupTableColumnEvent.bind(this, 'headerContextPopup'))),
					t.headerClickPopup && !this.columnSubscribers.headerClickPopup && ((this.columnSubscribers.headerClickPopup = this.loadPopupTableColumnEvent.bind(this, 'headerClickPopup')), this.subscribe('column-click', this.columnSubscribers.headerClickPopup)),
					t.headerDblClickPopup && !this.columnSubscribers.headerDblClickPopup && ((this.columnSubscribers.headerDblClickPopup = this.loadPopupTableColumnEvent.bind(this, 'headerDblClickPopup')), this.subscribe('column-dblclick', this.columnSubscribers.headerDblClickPopup)),
					t.headerPopup && this.initializeColumnHeaderPopup(e),
					t.contextPopup && !this.columnSubscribers.contextPopup && ((this.columnSubscribers.contextPopup = this.loadPopupTableCellEvent.bind(this, 'contextPopup')), this.subscribe('cell-contextmenu', this.columnSubscribers.contextPopup), this.table.on('cellTapHold', this.loadPopupTableCellEvent.bind(this, 'contextPopup'))),
					t.clickPopup && !this.columnSubscribers.clickPopup && ((this.columnSubscribers.clickPopup = this.loadPopupTableCellEvent.bind(this, 'clickPopup')), this.subscribe('cell-click', this.columnSubscribers.clickPopup)),
			...
			loadPopupEvent(e, t, i, s) {
				...
				i._group ? (i = i._group) : i._row && (i = i._row),
					(e =
						'function' == typeof e
							? e.call(this.table, t, i.getComponent(), function (e) {
									o = e
							  })
							: e),
		...
		PrintModule: class extends M {
			...
			printFullscreen(e, t, i) {
				...
				;(this.manualBlock = !0),
					...
					this.table.options.printHeader && (a.classList.add('tabulator-print-header'), 'string' == typeof (s = 'function' == typeof this.table.options.printHeader ? this.table.options.printHeader.call(this.table) : this.table.options.printHeader) ? (a.innerHTML = s) : a.appendChild(s), this.element.appendChild(a)),
					this.element.appendChild(h),
					this.table.options.printFooter && (l.classList.add('tabulator-print-footer'), 'string' == typeof (o = 'function' == typeof this.table.options.printFooter ? this.table.options.printFooter.call(this.table) : this.table.options.printFooter) ? (l.innerHTML = o) : l.appendChild(o), this.element.appendChild(l)),
		...
		ReactiveDataModule: class extends M {
						...
						value: function () {
							...
							if (!i.blocked && t === i.currentVersion) {
								if (
									(i.block('data-splice'),
									l &&
										((s = !!e[r] && i.table.rowManager.getRowFromDataObject(e[r]))
											? l.forEach(e => {
			...
			unwatchData() {
				if (!1 !== this.data) for (var e in this.origFuncs) Object.defineProperty(this.data, e, { enumerable: !0, configurable: !0, writable: !0, value: this.origFuncs.key })
			}
			watchRow(e) {
				var t = e.getData()
		...
		ResizeColumnsModule: class extends M {
			...
			columnWidthUpdated(e) {
				e.modules.frozen &&
					(this.table.modules.frozenColumns.leftColumns.includes(e)
						? this.table.modules.frozenColumns.leftColumns.forEach(e => {
								this.reinitializeColumn(e)
						  })
						: this.table.modules.frozenColumns.rightColumns.includes(e) &&
			...
			initializeColumn(e, t, i, s) {
				var o = this,
					...
					r = {},
					a = i.getLastColumn()
				if (('header' === e && (r = { variableHeight: 'textarea' == i.definition.formatter || i.definition.variableHeight }), (!0 === n || n == e) && this._checkResizability(a))) {
			...
			_mouseDown(e, t, i) {
				...
				function r(e) {
					o.table.options.resizableColumnGuide && (o.resize(e, t), s.remove()),
						...
						o.startWidth !== t.getWidth() && (o.table.columnManager.verticalAlignHeaders(), o.dispatch('column-resized', t), o.dispatchExternal('columnResized', t.getComponent()))
				}
				this.dispatchExternal('columnResizing', t.getComponent()),
					o.table.options.resizableColumnGuide &&
						((s = document.createElement('span')).classList.add('tabulator-col-resize-guide'),
		...
		ResizeRowsModule: class extends M {
			...
			initializeRow(e) {
				...
				s.addEventListener('mousedown', n),
					s.addEventListener('touchstart', n, { passive: !0 }),
				...
				o.addEventListener('mousedown', r), o.addEventListener('touchstart', r, { passive: !0 }), i.appendChild(s), i.appendChild(o)
			}
			resize(e, t) {
			...
			_mouseDown(e, t, i) {
				...
				o.dispatchExternal('rowResizing', t.getComponent()),
					o.table.options.resizableRowGuide &&
						((s = document.createElement('span')).classList.add('tabulator-row-resize-guide'),
						o.table.element.appendChild(s),
						setTimeout(() => {
			...
			initialize() {
				if (this.table.options.autoResize) {
					...
					;(this.tableHeight = t.element.clientHeight),
						...
						t.element.parentNode && ((this.containerHeight = t.element.parentNode.clientHeight), (this.containerWidth = t.element.parentNode.clientWidth)),
						'undefined' != typeof IntersectionObserver && 'undefined' != typeof ResizeObserver && 'virtual' === t.rowManager.getRenderMode()
							? (this.initializeVisibilityObserver(),
							  ...
							  this.table.element.parentNode &&
									...
									(e.getPropertyValue('max-height') || e.getPropertyValue('min-height')) &&
									((this.containerObserver = new ResizeObserver(e => {
										if (!t.browserMobile || (t.browserMobile && (!t.modules.edit || (t.modules.edit && !t.modules.edit.currentCell)))) {
											var i = Math.floor(e[0].contentRect.height),
												s = Math.floor(e[0].contentRect.width)
		...
		ResponsiveLayoutModule: class extends M {
			...
			initialize() {
				this.table.options.responsiveLayout &&
					...
					'collapse' === this.table.options.responsiveLayout && (this.subscribe('row-data-changed', this.generateCollapsedRowContent.bind(this)), this.subscribe('row-init', this.initializeRow.bind(this)), this.subscribe('row-layout', this.layoutRow.bind(this))))
			}
			tableRedraw(e) {
			...
			initializeRow(e) {
				var t
				'calc' !== e.type && ((t = document.createElement('div')).classList.add('tabulator-responsive-collapse'), (e.modules.responsiveLayout = { element: t, open: this.collapseStartOpen }), this.collapseStartOpen || (t.style.display = 'none'))
			}
			layoutRow(e) {
				var t = e.getElement()
						...
						if (o.definition.title && o.field)
							if (o.modules.format && this.table.options.responsiveLayoutCollapseUseFormatters) {
								...
								;(t = {
									...
									s.push({ field: o.field, title: o.definition.title, value: o.modules.format.formatter.call(this.table.modules.format, t, o.modules.format.params, r) })
							} else s.push({ field: o.field, title: o.definition.title, value: n })
					}),
					s
				)
			}
				...
				return (
					e.forEach(e => {
						...
						o.appendChild(r),
							...
							e.value instanceof Node ? ((i = document.createElement('div')).appendChild(e.value), n.appendChild(i)) : (n.innerHTML = e.value),
							s.appendChild(o),
							s.appendChild(n),
							t.appendChild(s)
					}),
		...
		SelectRangeModule: class extends M {
			...
			initialize() {
				this.options('selectableRange') &&
					(this.options('selectableRows') ? console.warn('SelectRange functionality cannot be used in conjunction with row selection') : ((this.maxRanges = this.options('selectableRange')), this.initializeTable(), this.initializeWatchers()),
			...
			updateHeaderColumn() {
				...
				this.rowSelection &&
					...
					this.rowHeader && ((this.rowHeader.definition.cssClass = this.rowHeader.definition.cssClass + ' tabulator-range-row-header'), this.rowHeader.definition.headerSort && console.warn('Using column headerSort with selectableRangeRows option may result in unpredictable behavior'), this.rowHeader.definition.editor && console.warn('Using column editor with selectableRangeRows option may result in unpredictable behavior'))),
			...
			handleColumnResized(e) {
				var t
				;('column' !== this.selecting && 'all' !== this.selecting) ||
					((t = this.ranges.some(t => t.occupiesColumn(e))),
					t &&
			...
			navigate(e, t, i) {
				...
				if ((this.ranges.length > 1 && (this.ranges = this.ranges.filter(e => (e === this.activeRange ? (e.setEnd(e.start.row, e.start.col), !0) : (e.destroy(), !1)))), (o = this.activeRange), (r = (n = t ? o.end : o.start).row), (a = n.col), e))
					switch (i) {
						case 'left':
				...
				return (
					this.rowHeader && 0 === a && (a = 1),
					(s = a !== n.col || r !== n.row),
					t || o.setStart(r, a),
					o.setEnd(r, a),
					t || (this.selecting = 'cell'),
					s ? ((l = this.getRowByRangePos(o.end.row)), (h = this.getColumnByRangePos(o.end.col)), ('left' !== i && 'right' !== i) || null !== h.getElement().parentNode ? (('up' !== i && 'down' !== i) || null !== l.getElement().parentNode ? this.autoScroll(o, l.getElement(), h.getElement()) : l.getComponent().scrollTo(void 0, !1)) : h.getComponent().scrollTo(void 0, !1), this.layoutElement(), !0) : void 0
				)
			}
			rangeRemoved(e) {
			...
			findJumpRow(e, t, i, s, o) {
				return (
					i && (t = t.reverse()),
					this.findJumpItem(s, o, t, function (t) {
			...
			autoScroll(e, t, i) {
				var s,
					...
					r,
					a,
					l = this.table.rowManager.element
				void 0 === t && (t = this.getRowByRangePos(e.end.row).getElement()),
					...
					(o = { left: i.offsetLeft, right: i.offsetLeft + i.offsetWidth, top: t.offsetTop, bottom: t.offsetTop + t.offsetHeight }),
					(n = { left: l.scrollLeft, right: Math.ceil(l.scrollLeft + l.clientWidth), top: l.scrollTop, bottom: l.scrollTop + l.offsetHeight - this.table.rowManager.scrollbarWidth }),
					...
					r || (o.left < n.left ? ((l.scrollLeft = o.left), s && (l.scrollLeft -= s.offsetWidth)) : o.right > n.right && (l.scrollLeft = o.right - l.clientWidth)),
			...
			addRange(e, t) {
				var i
				return !0 !== this.maxRanges && this.ranges.length >= this.maxRanges && this.ranges.shift().destroy(), (i = new Ve(this.table, this, e, t)), (this.activeRange = i), this.ranges.push(i), this.rangeContainer.appendChild(i.element), i
			}
			resetRanges() {
				var e, t, i
				return this.ranges.forEach(e => e.destroy()), (this.ranges = []), (e = this.addRange()), this.table.rowManager.activeRows.length && ((i = this.table.rowManager.activeRows[0].cells.filter(e => e.column.visible)), (t = i[this.rowHeader ? 1 : 0]) && (e.setBounds(t), this.initializeFocus(t))), e
			}
			tableDestroyed() {
		...
		SelectRowModule: class extends M {
			...
			initialize() {
				this.deprecatedOptionsCheck(),
					...
					!1 !== this.table.options.selectableRows && (this.subscribe('row-init', this.initializeRow.bind(this)), this.subscribe('row-deleting', this.rowDeleted.bind(this)), this.subscribe('rows-wipe', this.clearSelectionData.bind(this)), this.subscribe('rows-retrieve', this.rowRetrieve.bind(this)), this.table.options.selectableRows && !this.table.options.selectableRowsPersistence && this.subscribe('data-refreshing', this.deselectRows.bind(this)))
			}
			deprecatedOptionsCheck() {}
			rowRetrieve(e, t) {
			...
			initializeRow(e) {
				...
				;(e.modules.select = { selected: !1 }),
					...
					t.checkRowSelectability(e) &&
						t.table.options.selectableRows &&
						'highlight' != t.table.options.selectableRows &&
						('click' === t.table.options.selectableRowsRangeMode
							? s.addEventListener('click', this.handleComplexRowClick.bind(this, e))
			...
			handleComplexRowClick(e, t) {
				if (t.shiftKey) {
					...
					t.ctrlKey || t.metaKey
						...
						: (this.deselectRows(void 0, !0), !0 !== this.table.options.selectableRows && r.length > this.table.options.selectableRows && (r = r.slice(0, this.table.options.selectableRows)), this.selectRows(r)),
			...
			selectRows(e) {
				...
				Array.isArray(t)
					? t.length &&
					  ...
					  this._rowSelectionChanged(!1, s))
					: t && this._selectRow(t, !1, !0)
			}
			_selectRow(e, t, i) {
			...
			deselectRows(e, t) {
				...
				Array.isArray(i)
					? i.length &&
					  ...
					  this._rowSelectionChanged(t, [], o))
					: i && this._deselectRow(i, t, !0)
			}
			_deselectRow(e, t) {
				var i,
					s,
			...
			_rowSelectionChanged(e, t = [], i = []) {
				this.headerCheckboxElement && (0 === this.selectedRows.length ? ((this.headerCheckboxElement.checked = !1), (this.headerCheckboxElement.indeterminate = !1)) : this.table.rowManager.rows.length === this.selectedRows.length ? ((this.headerCheckboxElement.checked = !0), (this.headerCheckboxElement.indeterminate = !1)) : ((this.headerCheckboxElement.indeterminate = !0), (this.headerCheckboxElement.checked = !1))),
					e || (Array.isArray(t) || (t = [t]), (t = t.map(e => e.getComponent())), Array.isArray(i) || (i = [i]), (i = i.map(e => e.getComponent())), this.dispatchExternal('rowSelectionChanged', this.getSelectedData(), this.getSelectedRows(), t, i))
			}
			...
			childRowSelection(e, t) {
				...
				if (t) for (let e of i) this._selectRow(e, !0)
				else for (let e of i) this._deselectRow(e, !0)
			}
		},
		SortModule: je,
		SpreadsheetModule: class extends M {
			...
			initialize() {
				this.options('spreadsheet') &&
					...
					this.options('spreadsheetData') && this.options('spreadsheetSheets') && (console.warn('You cannot use spreadsheetData and spreadsheetSheets at the same time, ignoring spreadsheetData'), (this.table.options.spreadsheetData = !1)),
		...
		TooltipModule: class extends M {
			...
			deprecatedOptionsCheck() {}
			initializeColumn(e) {
				e.definition.headerTooltip && !this.headerSubscriber && ((this.headerSubscriber = !0), this.subscribe('column-mousemove', this.mousemoveCheck.bind(this, 'headerTooltip')), this.subscribe('column-mouseout', this.mouseoutCheck.bind(this, 'headerTooltip'))),
					e.definition.tooltip && !this.tooltipSubscriber && ((this.tooltipSubscriber = !0), this.subscribe('cell-mousemove', this.mousemoveCheck.bind(this, 'tooltip')), this.subscribe('cell-mouseout', this.mouseoutCheck.bind(this, 'tooltip')))
			}
			...
			loadTooltip(e, t, i) {
				var s, o, r
				'function' == typeof i &&
					(i = i(e, t.getComponent(), function (e) {
						o = e
					})),
						...
						: ((s = document.createElement('div')),
						  !0 === i &&
								(t instanceof n
									? (i = t.value)
									: t.definition.field
									? this.langBind('columns|' + t.definition.field, e => {
											s.innerHTML = i = e || t.definition.title
									  })
									: (i = t.definition.title)),
						  (s.innerHTML = i)),
					(i || 0 === i || !1 === i) &&
						(s.classList.add('tabulator-tooltip'),
	...
	var Ye = class extends O {
		static extendModule() {
			O.initializeModuleBinder(Ke), O._extendModule(...arguments)
		}
		static registerModule() {
			O.initializeModuleBinder(Ke), O._registerModule(...arguments)
		}
		constructor(e, t, i) {
			super(e, t, Ke)
		}
